...
const grammarA1: AssessmentQuestion[] = [
  {
    id: 'g-a1-001', skill: 'grammar', difficulty: 'A1',
  ...
  {
    id: 'g-a1-002', skill: 'grammar', difficulty: 'A1',
    question: 'Which sentence is correct?',
    options: ['I are happy.', 'He am happy.', 'They is happy.', 'We are happy.'],
    correct: 'We are happy.',
    grammar_slug: 'to-be',
  },
  {
    id: 'g-a1-003', skill: 'grammar', difficulty: 'A1',
  ...
  {
    id: 'g-a1-004', skill: 'grammar', difficulty: 'A1',
  ...
  {
    id: 'g-a1-005', skill: 'grammar', difficulty: 'A1',
  ...
  {
    id: 'g-a1-006', skill: 'grammar', difficulty: 'A1',
    question: 'Which is the correct negative?',
    options: ["He don't work here.", "He doesn't works here.", "He doesn't work here.", "He not work here."],
    correct: "He doesn't work here.",
    grammar_slug: 'present-simple',
  },
  {
    id: 'g-a1-007', skill: 'grammar', difficulty: 'A1',
  ...
  {
    id: 'g-a1-008', skill: 'grammar', difficulty: 'A1',
  ...
  {
    id: 'g-a1-009', skill: 'grammar', difficulty: 'A1',
  ...
  {
    id: 'g-a1-010', skill: 'grammar', difficulty: 'A1',
...
const grammarA2: AssessmentQuestion[] = [
  {
    id: 'g-a2-001', skill: 'grammar', difficulty: 'A2',
  ...
  {
    id: 'g-a2-002', skill: 'grammar', difficulty: 'A2',
  ...
  {
    id: 'g-a2-003', skill: 'grammar', difficulty: 'A2',
  ...
  {
    id: 'g-a2-004', skill: 'grammar', difficulty: 'A2',
  ...
  {
    id: 'g-a2-005', skill: 'grammar', difficulty: 'A2',
  ...
  {
    id: 'g-a2-006', skill: 'grammar', difficulty: 'A2',
  ...
  {
    id: 'g-a2-007', skill: 'grammar', difficulty: 'A2',
  ...
  {
    id: 'g-a2-008', skill: 'grammar', difficulty: 'A2',
  ...
  {
    id: 'g-a2-009', skill: 'grammar', difficulty: 'A2',
  ...
  {
    id: 'g-a2-010', skill: 'grammar', difficulty: 'A2',
...
const grammarB1: AssessmentQuestion[] = [
  {
    id: 'g-b1-001', skill: 'grammar', difficulty: 'B1',
  ...
  {
    id: 'g-b1-002', skill: 'grammar', difficulty: 'B1',
  ...
  {
    id: 'g-b1-003', skill: 'grammar', difficulty: 'B1',
  ...
  {
    id: 'g-b1-004', skill: 'grammar', difficulty: 'B1',
  ...
  {
    id: 'g-b1-005', skill: 'grammar', difficulty: 'B1',
  ...
  {
    id: 'g-b1-006', skill: 'grammar', difficulty: 'B1',
  ...
  {
    id: 'g-b1-007', skill: 'grammar', difficulty: 'B1',
  ...
  {
    id: 'g-b1-008', skill: 'grammar', difficulty: 'B1',
  ...
  {
    id: 'g-b1-009', skill: 'grammar', difficulty: 'B1',
  ...
  {
    id: 'g-b1-010', skill: 'grammar', difficulty: 'B1',
...
const vocabularyA1: AssessmentQuestion[] = [
  {
    id: 'v-a1-001', skill: 'vocabulary', difficulty: 'A1',
    question: 'What is the opposite of "big"?',
    options: ['tall', 'small', 'heavy', 'fast'],
    correct: 'small',
  },
  {
    id: 'v-a1-002', skill: 'vocabulary', difficulty: 'A1',
...
const readingA1A2: AssessmentQuestion[] = [
  ...
  },
  {
    ...
    options: ["She doesn't like her job.", 'She moved recently.', 'Her family is in Spain.', 'Berlin is far.'],
    correct: 'Her family is in Spain.',
  },
  {
    id: 'r-a2-002', skill: 'reading', difficulty: 'A2',
    question: 'Read: "Sale! Everything is 30% off this weekend only." — When does the sale end?',
    options: ['At the end of the month', 'After the weekend', 'On Friday', 'At midnight'],
    correct: 'After the weekend',
  },
  {
    id: 'r-a2-003', skill: 'reading', difficulty: 'A2',
...
const readingB1B2: AssessmentQuestion[] = [
  {
    id: 'r-b1-001', skill: 'reading', difficulty: 'B1',
    ...
    options: ['The project was late.', 'The report quality was poor.', 'The client refused to pay.', 'The team was too small.'],
    correct: 'The report quality was poor.',
  },
  {
    id: 'r-b1-002', skill: 'reading', difficulty: 'B1',
  ...
  {
    id: 'r-b1-003', skill: 'reading', difficulty: 'B1',
    ...
    options: ['Solar is cheaper than wind.', 'Fossil fuels are getting more expensive.', 'Renewable energy is becoming more affordable.', 'Wind is the best renewable source.'],
    correct: 'Renewable energy is becoming more affordable.',
  },
  {
    id: 'r-b2-001', skill: 'reading', difficulty: 'B2',
    ...
    options: ['Poor sleep definitely causes poor thinking.', 'There is a link between poor sleep and poor thinking, but cause and effect is not proven.', 'The study had no useful results.', 'Cognitive performance causes sleep deprivation.'],
...
export function adjustLevel(
  ...
  if (direction === 'up') return LEVEL_ORDER[Math.min(idx + 1, LEVEL_ORDER.length - 1)]
