...
export const grammarTopics: GrammarTopic[] = [
  ...
  },
  {
    ...
    examples: [
      ...
      { english: "There aren't any oranges left." },
  ...
  },
  {
    ...
    examples: [
      { english: 'Turn off your phone.', note: 'instruction' },
      { english: "Don't park here.", note: 'prohibition' },
  ...
  },
  {
    ...
    examples: [
      { english: 'The meeting is at 9 am on Monday.' },
      { english: 'She was born in March 1995.' },
      { english: 'I usually study in the evening.' },
