...
const basic_requests: PhrasebookCategory = {
  ...
  phrases: [
    ...
    {
      english: 'How do you say [word] in English?',
      context: 'Asking for a translation',
      register: 'neutral',
    },
    {
      english: 'What does [word] mean?',
...
const numbers_time_a1: PhrasebookCategory = {
  ...
  phrases: [
    ...
    {
      english: "It's [time] o'clock.",
      context: 'Telling the time on the hour',
      register: 'neutral',
    },
    {
      english: "It's half past [hour].",
      context: 'Telling the time at :30',
      register: 'neutral',
    },
    {
      english: "It's quarter past [hour].",
      context: 'Telling the time at :15',
      register: 'neutral',
    },
    {
      english: "It's quarter to [hour].",
      context: 'Telling the time at :45',
      register: 'neutral',
    },
    {
      english: 'The meeting is at [time].',
    ...
    {
      english: "It's [price] pounds/euros.",
      context: 'Stating a price',
      register: 'neutral',
    },
    {
...
const shopping_basic_a1: PhrasebookCategory = {
  ...
  phrases: [
    ...
    {
      english: 'Do you have this in [size/colour]?',
    ...
    {
      english: "It's too big / small / expensive.",
...
const asking_directions_a1: PhrasebookCategory = {
  ...
  phrases: [
    ...
    {
      english: "It's on the left / right.",
      context: 'Describing a location',
      register: 'neutral',
    },
    {
      english: "It's next to / opposite [landmark].",
      context: 'Describing a location',
      register: 'neutral',
    },
    {
      english: "It's about [number] minutes on foot.",
      context: 'Describing distance',
      register: 'neutral',
    },
    {
      english: 'Take the [number] bus.',
      context: 'Giving transport advice',
      register: 'neutral',
    },
    {
      english: "Sorry, I don't know this area.",
...
const restaurant_a2: PhrasebookCategory = {
  ...
  phrases: [
    ...
    {
      english: "I'll have [dish], please.",
      context: 'Ordering food',
      register: 'neutral',
    },
    {
      english: 'Could I have [dish] instead of [dish]?',
    ...
    {
      english: 'Is [dish] vegetarian / vegan?',
      context: 'Asking about dietary options',
      register: 'neutral',
    },
    {
      english: "Excuse me, we've been waiting for a while.",
...
const transport_booking_a2: PhrasebookCategory = {
  ...
  phrases: [
    ...
    {
      english: 'A return ticket to [destination], please.',
    ...
    {
      english: 'Is there a direct train to [destination]?',
      context: 'Asking about connections',
      register: 'neutral',
    },
    {
      english: "I'd like to book a seat.",
      context: 'Reserving a seat',
      register: 'neutral',
    },
    {
      english: "I've missed my train / flight.",
    ...
    {
      english: 'I have a connecting flight at [time].',
      context: 'Informing about a connection',
      register: 'neutral',
    },
    {
      english: 'Is there a tourist pass available?',
...
const weather_talk_a2: PhrasebookCategory = {
  ...
  phrases: [
    ...
    {
      english: "It's sunny / cloudy / rainy.",
      context: 'Describing current weather',
      register: 'neutral',
    },
    {
      english: "It's quite warm / cold today.",
      context: 'Describing temperature',
      register: 'neutral',
    },
    {
      english: "It's going to rain later.",
      context: 'Predicting weather',
      register: 'neutral',
    },
    {
      english: "What's the forecast for tomorrow?",
      context: "Asking about tomorrow's weather",
      register: 'neutral',
    },
    {
      english: 'I love this kind of weather.',
      context: 'Expressing preference',
      register: 'informal',
    },
    {
      english: "I hate it when it's this cold!",
      context: 'Expressing dislike',
      register: 'informal',
    },
    {
      english: 'You should bring an umbrella.',
...
const making_plans_a2: PhrasebookCategory = {
  ...
  phrases: [
    ...
    {
      english: 'Would you like to [do something]?',
    ...
    {
      english: "I'm afraid I can't. I have other plans.",
      context: 'Declining an invitation',
      register: 'neutral',
    },
    {
      english: 'Maybe another time.',
    ...
    {
      english: "Let's meet at [time] at [place].",
      context: 'Confirming arrangements',
      register: 'neutral',
    },
    {
      english: "I'll be there at [time].",
      context: 'Confirming attendance',
      register: 'neutral',
    },
    {
      english: 'Can we change the time / date?',
    ...
    {
      english: "I'll be there in about 10 minutes.",
...
const feelings_a2: PhrasebookCategory = {
  ...
  phrases: [
    ...
    {
      english: "I can't wait for [event]!",
...
const phone_calls_b1: PhrasebookCategory = {
  ...
  phrases: [
    ...
    {
      english: 'Could I speak to [Name], please?',
      context: 'Asking to speak to someone',
      register: 'formal',
    },
    {
      english: "I'm afraid [Name] isn't available.",
    ...
    {
      english: 'Could you ask [Name] to call me back?',
    ...
    {
      english: "I'm calling about [topic].",
      context: 'Stating the reason for your call',
      register: 'neutral',
    },
    {
      english: "I'm sorry, you're breaking up.",
      context: 'Poor signal',
      register: 'neutral',
    },
    {
    ...
    {
      english: "I'll put you on hold for a moment.",
...
const job_interview_b1: PhrasebookCategory = {
  ...
  phrases: [
    ...
    {
      english: "I'm very interested in this position.",
      context: 'Expressing interest',
      register: 'formal',
    },
    {
      english: 'In my previous role, I was responsible for...',
      context: 'Describing past experience',
      register: 'formal',
    },
    {
      english: 'I have experience in [field/skill].',
      context: 'Mentioning a skill',
      register: 'formal',
    },
    {
      english: 'My greatest strength is [strength].',
      context: 'Answering a strengths question',
      register: 'formal',
    },
    {
      english: 'I am a team player and also enjoy working independently.',
      context: 'Describing work style',
      register: 'formal',
    },
    {
      english: "I'm a quick learner.",
      context: 'Describing learning ability',
      register: 'formal',
    },
    {
      english: 'What does a typical day look like in this role?',
      context: 'Asking about the job',
      register: 'formal',
    },
    {
      english: 'When can I expect to hear from you?',
...
const giving_opinions_b1: PhrasebookCategory = {
  ...
  phrases: [
    ...
    {
      english: 'I partially agree, but...',
      context: 'Partial agreement',
      register: 'neutral',
    },
    {
      english: "I'm afraid I don't agree.",
      context: 'Polite disagreement',
      register: 'neutral',
    },
    {
      english: "That's a good point, but...",
      context: 'Acknowledging then disagreeing',
      register: 'neutral',
    },
    {
      english: 'I see your point, however...',
      context: 'Countering an argument',
      register: 'neutral',
    },
    {
      english: 'It depends on...',
      context: 'Qualified answer',
      register: 'neutral',
    },
    {
...
const health_appointments_b1: PhrasebookCategory = {
  ...
  phrases: [
    ...
    {
      english: 'I have a pain in my [body part].',
      context: 'Describing pain location',
      register: 'neutral',
    },
    {
      english: 'The pain started [time] ago.',
      context: 'Describing when symptoms began',
      register: 'neutral',
    },
    {
      english: 'I have a temperature of [degrees].',
    ...
    {
      english: 'When should I come back?',
...
const formal_emails_b2: PhrasebookCategory = {
  ...
  phrases: [
    {
      english: 'I am writing to enquire about...',
      context: 'Opening — asking for information',
      register: 'formal',
    },
    {
      english: 'I am writing with reference to...',
      context: 'Opening — referencing something',
      register: 'formal',
    },
    {
      english: 'Thank you for your email of [date].',
      context: 'Acknowledging a received email',
      register: 'formal',
    },
    {
      english: 'Further to our conversation, ...',
    ...
    {
      english: 'Please find attached [document].',
    ...
    {
      english: 'Yours faithfully, / Yours sincerely,',
      context: 'Formal sign-off',
      register: 'formal',
    },
    {
      english: 'Kind regards, / Best regards,',
...
const negotiations_b2: PhrasebookCategory = {
  ...
  phrases: [
    {
      english: 'Could we come to a compromise?',
      context: 'Proposing a middle ground',
      register: 'formal',
    },
    {
      english: 'I see your point, but from our perspective...',
      context: 'Presenting your side',
      register: 'neutral',
    },
    {
      english: "We'd be willing to [offer], provided that...",
      context: 'Making a conditional offer',
      register: 'formal',
    },
    {
      english: "That doesn't quite work for us because...",
      context: 'Politely rejecting a proposal',
      register: 'neutral',
    },
    {
      english: 'What if we were to [suggest alternative]?',
      context: 'Proposing an alternative',
      register: 'neutral',
    },
    {
      english: 'We need to consider all the options.',
      context: 'Stalling for time',
      register: 'neutral',
    },
    {
      english: "I'll need to discuss this with my team.",
      context: 'Deferring a decision',
      register: 'neutral',
    },
    {
      english: 'Can we revisit this point later?',
...
const academic_discussion_b2: PhrasebookCategory = {
  ...
  phrases: [
    {
      english: 'Evidence suggests that...',
      context: 'Presenting evidence',
      register: 'formal',
    },
    {
      english: 'According to [source], ...',
      context: 'Citing a source',
      register: 'formal',
    },
    {
      english: 'It could be argued that...',
    ...
    {
      english: 'This raises the question of...',
      context: 'Introducing a question',
      register: 'formal',
    },
    {
      english: 'There is no denying that...',
      context: 'Stating an undeniable fact',
      register: 'formal',
    },
    {
      english: 'The implications of this are significant.',
      context: 'Highlighting consequences',
      register: 'formal',
    },
    {
      english: 'In summary, ...',
      context: 'Summarising a point',
      register: 'formal',
    },
    {
      english: 'This leads me to conclude that...',
...
const presentations_c1: PhrasebookCategory = {
  ...
  phrases: [
    {
      english: "Today I'd like to talk to you about...",
      context: 'Opening a presentation',
      register: 'formal',
    },
    {
      english: "I'll begin by outlining the key issues, then move on to...",
      context: 'Signposting the structure',
      register: 'formal',
    },
    {
      english: 'As you can see from this slide, ...',
      context: 'Referring to a visual aid',
      register: 'formal',
    },
    {
      english: "I'd like to draw your attention to...",
      context: 'Highlighting an important point',
      register: 'formal',
    },
    {
      english: 'Building on this point, ...',
      context: 'Developing an argument',
      register: 'formal',
    },
    {
      english: 'This brings me to my next point, which is...',
      context: 'Transitioning between sections',
      register: 'formal',
    },
    {
      english: 'What this essentially means is that...',
      context: 'Clarifying a complex idea',
      register: 'formal',
    },
    {
      english: "I'd like to take a step back and consider...",
      context: 'Broadening the perspective',
      register: 'formal',
    },
    {
      english: 'The data clearly indicates that...',
    ...
    {
      english: "I'm happy to take questions at the end.",
      context: 'Managing Q&A',
      register: 'formal',
    },
    {
      english: "That's a very pertinent question.",
      context: 'Acknowledging a good question',
      register: 'formal',
    },
    {
      english: 'To summarise the key takeaways, ...',
...
const complex_arguments_c1: PhrasebookCategory = {
  ...
  phrases: [
    {
      english: 'One might argue that..., however the evidence suggests...',
      context: 'Presenting a counterargument then rebutting',
      register: 'formal',
    },
    {
      english: 'The distinction between X and Y is crucial here.',
      context: 'Drawing an important distinction',
      register: 'formal',
    },
    {
      english: 'While I take your point, I would contend that...',
      context: 'Polite disagreement',
      register: 'formal',
    },
    {
      english: 'The issue is more nuanced than it first appears.',
      context: 'Suggesting complexity',
      register: 'formal',
    },
    {
      english: 'This argument fails to account for...',
      context: 'Identifying a flaw in reasoning',
      register: 'formal',
    },
    {
      english: 'Correlation does not necessarily imply causation.',
      context: 'Questioning a causal claim',
      register: 'formal',
    },
    {
      english: 'We should be cautious about generalising from a single case.',
      context: 'Raising methodological concern',
      register: 'formal',
    },
    {
      english: 'That notwithstanding, the broader trend is clear.',
      context: 'Acknowledging an exception while maintaining position',
      register: 'formal',
    },
    {
      english: 'The weight of evidence points convincingly to...',
      context: 'Summarising evidence',
      register: 'formal',
    },
    {
      english:
        'I concede that..., but this does not undermine my overall point.',
      context: 'Partial concession',
      register: 'formal',
    },
    {
      english: 'What is often overlooked in this debate is...',
      context: 'Introducing a neglected angle',
      register: 'formal',
    },
    {
      english: 'The implications of this are far-reaching.',
...
const professional_networking_c1: PhrasebookCategory = {
  ...
  phrases: [
    {
      english: 'I believe we have some mutual connections.',
      context: 'Breaking the ice at a professional event',
      register: 'formal',
    },
    {
      english:
        "I've been following your work on [topic] — it's really compelling.",
      context: 'Opening a conversation with a professional you admire',
      register: 'formal',
    },
    {
      english: "I'd love to pick your brain about [subject] sometime.",
    ...
    {
      english:
        "I'm currently working on [project] — it might align with what you're doing.",
      context: 'Finding common ground',
      register: 'neutral',
    },
    {
      english:
        "Could I connect you with [Name]? I think you'd have a lot to discuss.",
      context: 'Making an introduction',
      register: 'formal',
    },
    {
      english:
        "I'd be happy to share some resources on that if it would be useful.",
      context: 'Offering to help',
      register: 'neutral',
    },
    {
      english: "It was a pleasure speaking with you — let's stay in touch.",
      context: 'Closing a networking conversation',
      register: 'formal',
    },
    {
      english:
        "I'll send you a LinkedIn request so we can keep the conversation going.",
      context: 'Following up after meeting',
      register: 'neutral',
    },
    {
      english: 'Do you have a card, or shall I find you on LinkedIn?',
...
const conflict_resolution_c1: PhrasebookCategory = {
  ...
  phrases: [
    {
      english:
        'I sense there may be some tension around this issue — shall we address it openly?',
      context: 'Naming a conflict and inviting dialogue',
      register: 'formal',
    },
    {
      english:
        'I understand this is a difficult situation for all parties involved.',
      context: 'Showing empathy before discussing solutions',
      register: 'formal',
    },
    {
      english: "I'd like to hear your perspective before I share mine.",
      context: 'Demonstrating willingness to listen',
      register: 'neutral',
    },
    {
      english:
        'I think there may have been a misunderstanding — let me clarify my position.',
      context: 'Addressing a miscommunication',
      register: 'neutral',
    },
    {
      english: 'Our goal should be to find a solution that works for everyone.',
      context: 'Refocusing on shared interests',
      register: 'neutral',
    },
    {
      english:
        "I'm willing to reconsider my stance if you can walk me through your reasoning.",
      context: 'Showing openness to compromise',
      register: 'formal',
    },
    {
      english:
        'Could we agree to set this point aside for now and return to it later?',
      context: 'De-escalating a heated point',
      register: 'formal',
    },
    {
      english: 'I want to be direct without being dismissive of your concerns.',
      context: 'Balancing honesty with respect',
      register: 'neutral',
    },
    {
      english:
        'What would a satisfactory outcome look like from your perspective?',
      context: 'Inviting the other party to define success',
      register: 'formal',
    },
    {
      english: "I think we're closer to agreement than it might appear.",
...
const rhetoric_c2: PhrasebookCategory = {
  ...
  phrases: [
    {
      english: 'It would be remiss of us not to acknowledge that...',
      context: 'Formally recognising a point',
      register: 'formal',
    },
    {
      english: 'The crux of the matter is...',
      context: 'Getting to the heart of the issue',
      register: 'formal',
    },
    {
      english: 'Far from being a setback, this represents an opportunity.',
    ...
    {
      english: 'One cannot overstate the importance of...',
      context: 'Emphasising significance',
      register: 'formal',
    },
    {
      english: 'The time has come to reconsider our approach.',
      context: 'Calling for change',
      register: 'formal',
    },
    {
      english:
        'Not only does this fail to address the root cause, but it also...',
      context: 'Compounding criticism',
      register: 'formal',
    },
    {
      english: 'This begs the question: why has nothing been done?',
    ...
    {
      english: 'We would do well to remember that...',
      context: 'Offering wise counsel',
      register: 'formal',
    },
    {
      english: 'There is an inescapable irony in the fact that...',
      context: 'Pointing out contradiction or irony',
      register: 'formal',
    },
    {
      english: 'The evidence speaks for itself.',
...
const nuanced_discourse_c2: PhrasebookCategory = {
  ...
  phrases: [
    {
      english: 'It is worth noting, albeit with some caution, that...',
      context: 'Careful, hedged observation',
      register: 'formal',
    },
    {
      english: 'The picture is, of course, considerably more complex.',
      context: 'Signalling complexity',
      register: 'formal',
    },
    {
      english: 'Suffice it to say that...',
      context: 'Indicating something is enough without elaborating',
      register: 'formal',
    },
    {
      english: 'This is not to suggest that..., but rather...',
      context: 'Clarifying a potential misinterpretation',
      register: 'formal',
    },
    {
      english: 'The extent to which this holds true varies considerably.',
      context: 'Qualifying a generalisation',
      register: 'formal',
    },
    {
      english: 'I would be the first to admit that...',
      context: 'Honest concession',
      register: 'formal',
    },
    {
      english: 'Taken in isolation, this fact is misleading.',
      context: 'Warning about context',
      register: 'formal',
    },
    {
      english: 'There is a fine line between X and Y.',
      context: 'Drawing a subtle distinction',
      register: 'formal',
    },
    {
      english: 'The jury is still out on whether...',
      context: 'Saying something is not yet resolved',
      register: 'neutral',
    },
    {
      english: 'One is hard-pressed to find a compelling counter-argument.',
      context: 'Strong (but hedged) assertion',
      register: 'formal',
    },
    {
      english: 'This warrants further investigation.',
      context: 'Flagging something needs more research',
      register: 'formal',
    },
    {
      english: 'At the risk of oversimplifying, ...',
...
const legal_contractual_c2: PhrasebookCategory = {
  ...
  phrases: [
    {
      english: 'The terms set out herein are binding upon both parties.',
      context: 'Formal contract phrasing',
      register: 'formal',
    },
    {
      english: 'Notwithstanding the foregoing, ...',
      context: 'Introducing a qualification to a prior statement',
      register: 'formal',
    },
    {
      english: 'The party of the first part hereby agrees to...',
    ...
    {
      english: 'Time is of the essence with respect to delivery.',
      context: 'Stressing deadline importance',
      register: 'formal',
    },
    {
      english:
        'The licensor grants a non-exclusive, non-transferable licence to use...',
      context: 'Licensing language',
      register: 'formal',
    },
    {
      english:
        "Either party may terminate this agreement upon [n] days' written notice.",
      context: 'Termination clause',
      register: 'formal',
    },
    {
      english: 'This clause shall survive the termination of the agreement.',
    ...
    {
      english: 'Force majeure events shall excuse performance obligations.',
...
const social_commentary_c2: PhrasebookCategory = {
  ...
  phrases: [
    {
      english:
        'The systemic nature of this problem demands a structural response, not a piecemeal one.',
      context: 'Arguing for root-cause solutions',
      register: 'formal',
    },
    {
      english:
        'We risk conflating two very different phenomena if we treat them as equivalent.',
      context: 'Warning against false equivalence',
      register: 'formal',
    },
    {
      english: 'The dominant narrative obscures more than it reveals.',
      context: 'Challenging mainstream framing',
      register: 'formal',
    },
    {
      english:
        'There is a troubling tendency to mistake complexity for ambiguity.',
      context: 'Distinguishing nuance from vagueness',
      register: 'formal',
    },
    {
      english:
        'The discourse around this issue has been, at best, superficial.',
      context: 'Critiquing the quality of public debate',
      register: 'formal',
    },
    {
      english:
        'What we are witnessing is the logical consequence of decades of policy neglect.',
      context: 'Tracing cause and effect',
      register: 'formal',
    },
    {
      english:
        'Moral outrage, however justified, is not a substitute for analysis.',
      context: 'Calling for reason over emotion',
      register: 'formal',
    },
    {
      english:
        'The question is not whether change is needed, but who bears the cost of that change.',
      context: 'Reframing a debate around equity',
      register: 'formal',
    },
    {
      english: 'History offers no shortage of cautionary tales on this front.',
      context: 'Invoking historical precedent',
      register: 'formal',
    },
    {
      english:
        'We should resist the temptation to reduce a multifaceted issue to a single cause.',
      context: 'Opposing oversimplification',
      register: 'formal',
    },
    {
      english: 'The stakes could hardly be higher.',
