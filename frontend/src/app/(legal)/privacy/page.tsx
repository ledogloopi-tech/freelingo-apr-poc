  ...
  return (
    <div>
      ...
      <div className="border border-fl-border bg-fl-surface p-8 space-y-8">
        ...
        <section className="space-y-3">
          <h2 className="font-mono text-sm font-bold tracking-widest text-fl-fg uppercase">{t('s3Title')}</h2>
          <p className="font-mono text-sm text-fl-fg-2 leading-relaxed">{t('s3Intro')}</p>
          <ul className="space-y-1 pl-4">
            {s3Items.map((item) => (
              <li key={item} className="font-mono text-sm text-fl-fg-2 leading-relaxed flex gap-2">
                <span className="text-fl-muted-2 flex-shrink-0">—</span>
          ...
          <p className="font-mono text-sm text-fl-fg-2 leading-relaxed">{t('s3Footer')}</p>
        </section>
