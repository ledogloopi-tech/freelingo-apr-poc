...
| stripe_subscription_id          | string (nullable)   | Current Stripe subscription ID; used to ignore stale webhook events from older subscriptions for the same customer                                                                                                                                                                                  |
