...
│   ├── tests/                   # Vitest suite (31 test files, 409 tests)
...
- **Frontend**: Vitest, 31 test files, 409 tests covering stores, components, hooks, lib, i18n, app pages, billing paywall UI, and middleware; coverage is not configured/reported
