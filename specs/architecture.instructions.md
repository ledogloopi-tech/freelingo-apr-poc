...
│   └── tests/                   # pytest suite (43 test files, 906 tests)
│
...
│   ├── tests/                   # Vitest suite (32 test files, 412 tests)
...
- **Backend**: pytest + pytest-asyncio, 43 test files, 906 tests, 84.89% last measured coverage (target: 70%)
- **Frontend**: Vitest, 32 test files, 412 tests covering stores, components, hooks, lib, i18n, app pages, billing paywall UI, billing success verification, and middleware; coverage is not configured/reported
