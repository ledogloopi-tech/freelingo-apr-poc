...
- Lesson generation: `lesson_type`, `topic`, `unit_id`, `grammar_points`, `vocabulary_set_ids`, `week`, `day`, `valid_slugs`, optional `native_language_name` for lesson-level and per-exercise `native_explanation`.
