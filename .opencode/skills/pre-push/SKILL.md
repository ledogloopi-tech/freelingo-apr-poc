...
845 backend tests, >= 70% backend coverage required. Current backend coverage is 84.28%. SQLite in-memory, no Docker needed.
...
| 1    | pytest           | 845 backend tests, SQLite in-memory            |
