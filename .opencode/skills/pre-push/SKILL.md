...
875 backend tests, >= 70% backend coverage required. Current backend coverage is 85.27%. SQLite in-memory, no Docker needed.
...
| 1    | pytest           | 875 backend tests, SQLite in-memory            |
