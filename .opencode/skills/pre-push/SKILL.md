...
879 backend tests, >= 70% backend coverage required. Current backend coverage is 85.39%. SQLite in-memory, no Docker needed.
...
| 1    | pytest           | 879 backend tests, SQLite in-memory            |
