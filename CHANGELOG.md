...
- **Native explanation test coverage**: backend coverage now includes native-explanation endpoint generation/caching, grammar and phrasebook native-help generation/cache refresh, and native-language propagation during lazy lesson generation. Backend suite: 883 tests, 85.39% last measured coverage.
