...
down_revision: Union[str, None] = "0007_target_language"
...
def upgrade() -> None:
    ...
    op.create_foreign_key(
        "flashcards_user_id_fkey", "flashcards", "users", ["user_id"], ["id"],
        ondelete="CASCADE",
    )
    ...
    op.create_foreign_key(
        "study_plans_user_id_fkey", "study_plans", "users", ["user_id"], ["id"],
        ondelete="CASCADE",
    )
    ...
    op.create_foreign_key(
        "progress_user_id_fkey", "progress", "users", ["user_id"], ["id"],
        ondelete="CASCADE",
    )
    ...
    op.create_foreign_key(
        "lessons_study_plan_id_fkey", "lessons", "study_plans", ["study_plan_id"], ["id"],
        ondelete="CASCADE",
    )
    ...
    op.create_foreign_key(
        "exercises_lesson_id_fkey", "exercises", "lessons", ["lesson_id"], ["id"],
        ondelete="CASCADE",
    )
