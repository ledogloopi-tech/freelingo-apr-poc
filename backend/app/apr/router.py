...
APR_FEEDBACK_ID = "APR-R1-RM-01-L01-FEEDBACK-TECH"
APR_FEEDBACK_ERROR = (
    "APR could not load technical feedback. This is a feedback-service issue, "
    "not a language result."
)
APR_FEEDBACK_CONTENT = {
...
async def create_enter_the_connection_feedback_draft(
    ...
    try:
        ...
        response = AprFeedbackDraftResponse(
            ...
            acknowledgement=APR_FEEDBACK_CONTENT["acknowledgement"],
            primary_priority=APR_FEEDBACK_CONTENT["primary_priority"],
            cue=APR_FEEDBACK_CONTENT["cue"],
            retry_instruction=APR_FEEDBACK_CONTENT["retry_instruction"],
            uncertainty=APR_FEEDBACK_CONTENT["uncertainty"],
