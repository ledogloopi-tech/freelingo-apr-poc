...
A2_GRAMMAR_TOPICS: list[GrammarTopic] = [
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Ayer hablé con mi madre por teléfono.", translation="Yesterday I spoke with my mother on the phone."),
            GrammarExample(text="Comimos paella el domingo pasado.", translation="We ate paella last Sunday."),
            GrammarExample(text="¿Viviste en Barcelona el año pasado?", translation="Did you live in Barcelona last year?"),
            GrammarExample(text="Ellos llegaron a las ocho.", translation="They arrived at eight."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Ayer hablo con Juan.", correct="Ayer hablé con Juan.", note="\"Hablo\" es presente; para el pasado se necesita \"hablé\" con tilde."),
            GrammarMistake(wrong="Ayer comí la paella.", correct="Ayer comí paella.", note="En general no se usa artículo definido con comidas cuando se habla de consumirlas."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            ...
            GrammarExample(text="La semana pasada visité a mis abuelos.", translation="Last week I visited my grandparents."),
            GrammarExample(text="Hace tres años empecé a estudiar español.", translation="Three years ago I started studying Spanish."),
            GrammarExample(text="En 2015 nos mudamos a Madrid.", translation="In 2015 we moved to Madrid."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Hace dos años he viajado a Chile.", correct="Hace dos años viajé a Chile.", note="\"Hace + tiempo\" pide pretérito indefinido, no pretérito perfecto."),
            GrammarMistake(wrong="Desde dos años vivo aquí.", correct="Vivo aquí desde hace dos años.", note="\"Desde hace\" expresa duración desde el pasado hasta ahora."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Ayer no tuve tiempo para llamarte.", translation="Yesterday I didn't have time to call you."),
            GrammarExample(text="¿Qué hiciste el fin de semana?", translation="What did you do on the weekend?"),
            GrammarExample(text="Fui al médico y luego fui muy feliz.", translation="I went to the doctor and then I was very happy.", note="ir y ser"),
            GrammarExample(text="Ellos no quisieron venir a la cena.", translation="They didn't want to come to the dinner."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Ayer hice la comida.", correct="Ayer hice la comida.", note="Correcto. \"Hice\" es la forma correcta de hacer en indefinido para yo."),
            GrammarMistake(wrong="Él hico la maleta.", correct="Él hizo la maleta.", note="La tercera persona de hacer es \"hizo\", con z, no con c."),
        ],
        related=["preterito-indefinido-regular", "marcadores-temporales", "preterito-vs-imperfecto"],
    ),
    GrammarTopic(
        slug="imperfecto",
        ...
        examples=[
            GrammarExample(text="Cuando era pequeño, vivía en un pueblo.", translation="When I was little, I lived in a village."),
            GrammarExample(text="Antes íbamos a la playa todos los veranos.", translation="Before, we used to go to the beach every summer."),
            GrammarExample(text="Ella leía mientras yo cocinaba.", translation="She was reading while I was cooking."),
            GrammarExample(text="Hacía frío y llovía sin parar.", translation="It was cold and it was raining nonstop."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Cuando era pequeño, jugué al fútbol cada día.", correct="Cuando era pequeño, jugaba al fútbol cada día.", note="Los hábitos pasados requieren imperfecto, no indefinido."),
            GrammarMistake(wrong="Ayer iba al cine.", correct="Ayer fui al cine.", note="Con \"ayer\" y una acción concreta se usa indefinido, no imperfecto."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Estudiaba cuando me llamaste.", translation="I was studying when you called me."),
            GrammarExample(text="De joven, salía todos los viernes.", translation="When young, I used to go out every Friday."),
            GrammarExample(text="El verano pasado fui a Italia y visité Roma.", translation="Last summer I went to Italy and visited Rome."),
            GrammarExample(text="Hacía sol y los pájaros cantaban. De repente, empezó a llover.", translation="It was sunny and the birds were singing. Suddenly, it started to rain."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Mientras cociné, sonó el teléfono.", correct="Mientras cocinaba, sonó el teléfono.", note="\"Mientras + acción de fondo\" pide imperfecto."),
            GrammarMistake(wrong="Ayer estaba en casa todo el día.", correct="Ayer estuve en casa todo el día.", note="Con \"ayer\" y periodo definido se usa indefinido."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Suelo leer antes de dormir.", translation="I usually read before sleeping."),
            GrammarExample(text="De niño, solía pasar los veranos en el pueblo.", translation="As a child, I used to spend summers in the village."),
            GrammarExample(text="¿Sueles hacer ejercicio?", translation="Do you usually exercise?"),
            GrammarExample(text="Antes no solíamos viajar tanto.", translation="Before we didn't use to travel so much."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Solí ir al parque.", correct="Solía ir al parque.", note="\"Soler\" no tiene forma de indefinido. Se usa el imperfecto \"solía\"."),
            GrammarMistake(wrong="Suelo a comer a las dos.", correct="Suelo comer a las dos.", note="Soler rige infinitivo sin preposición."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="¿El libro? Lo leí ayer.", translation="The book? I read it yesterday."),
            GrammarExample(text="A María la vi en el supermercado.", translation="María? I saw her at the supermarket."),
            GrammarExample(text="No puedo encontrarlo.", translation="I can't find it."),
            GrammarExample(text="Estamos preparándola para la fiesta.", translation="We are preparing it for the party."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Lo vi a María.", correct="La vi. / Vi a María.", note="Si el OD es femenino, el pronombre debe ser \"la\"."),
            GrammarMistake(wrong="¿Las flores? Le compré ayer.", correct="¿Las flores? Las compré ayer.", note="OD femenino plural → \"las\", no \"le\"."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Le escribí una carta a mi abuela.", translation="I wrote a letter to my grandmother."),
            GrammarExample(text="¿Me puedes prestar tu boli?", translation="Can you lend me your pen?"),
            GrammarExample(text="Les explicamos la situación a los clientes.", translation="We explained the situation to the clients."),
            GrammarExample(text="Voy a darle el regalo mañana.", translation="I am going to give him/her the present tomorrow."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="La di el libro a María.", correct="Le di el libro a María.", note="El OI es \"le\" (invariable en género), no \"la\"."),
            GrammarMistake(wrong="Dí a Juan la noticia.", correct="Le di la noticia a Juan.", note="El OI debe aparecer con el pronombre, especialmente si se menciona la persona."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="¿El informe? Te lo envío ahora.", translation="The report? I'll send it to you now."),
            GrammarExample(text="Se lo expliqué a mis padres.", translation="I explained it to my parents."),
            GrammarExample(text="¿Me lo puedes repetir?", translation="Can you repeat it to me?"),
            GrammarExample(text="No quiero contárselo todavía.", translation="I don't want to tell it to him/her/them yet."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Le lo dije.", correct="Se lo dije.", note="La combinación \"le lo\" no existe; se convierte en \"se lo\"."),
            GrammarMistake(wrong="Lo se di.", correct="Se lo di.", note="El OI (se) debe ir antes del OD (lo)."),
        ],
        related=["pronombres-objeto-directo", "pronombres-objeto-indirecto", "imperativo-afirmativo"],
    ),
    GrammarTopic(
        slug="comparativos",
        title="Comparativos",
        ...
        examples=[
            GrammarExample(text="Madrid es más grande que Barcelona.", translation="Madrid is bigger than Barcelona."),
            GrammarExample(text="Este ejercicio es menos difícil que el anterior.", translation="This exercise is less difficult than the previous one."),
            GrammarExample(text="Ella es tan simpática como su hermana.", translation="She is as nice as her sister."),
            GrammarExample(text="Esta película es mejor que la otra.", translation="This film is better than the other one."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Es más mejor que el otro.", correct="Es mejor que el otro.", note="\"Mejor\" ya es comparativo; no necesita \"más\"."),
            GrammarMistake(wrong="Es tan alto que su padre.", correct="Es tan alto como su padre.", note="Las comparaciones de igualdad usan \"tan... como\", no \"tan... que\"."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Es el edificio más alto del mundo.", translation="It's the tallest building in the world."),
            GrammarExample(text="La paella está buenísima.", translation="The paella is absolutely delicious."),
            GrammarExample(text="Es la persona menos puntual de la oficina.", translation="He/she is the least punctual person in the office."),
            GrammarExample(text="El examen fue facilísimo.", translation="The exam was extremely easy."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Es el más mejor de todos.", correct="Es el mejor de todos.", note="\"Mejor\" ya es la forma superlativa de \"bueno\" para el relativo."),
            GrammarMistake(wrong="Es el más bueno.", correct="Es el mejor.", note="\"Bueno\" tiene comparativo/superlativo irregular: mejor, el mejor."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="No soy tan paciente como tú.", translation="I'm not as patient as you."),
            GrammarExample(text="En esta ciudad hay tanta contaminación como en otras capitales.", translation="In this city there is as much pollution as in other capitals."),
            GrammarExample(text="No hablo español tan bien como me gustaría.", translation="I don't speak Spanish as well as I'd like."),
            GrammarExample(text="Estaba tan cansado que me dormí en el sofá.", translation="I was so tired that I fell asleep on the sofa.", note="consecutivo"),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Tengo tan dinero como tú.", correct="Tengo tanto dinero como tú.", note="Con sustantivos se usa \"tanto/a/os/as\", no \"tan\"."),
            GrammarMistake(wrong="Es tanto amable como su madre.", correct="Es tan amable como su madre.", note="Con adjetivos se usa \"tan\", no \"tanto\"."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            ...
            GrammarExample(text="Hablad más bajo, por favor.", translation="Speak more quietly, please.", note="vosotros"),
            GrammarExample(text="Dime la verdad.", translation="Tell me the truth."),
            GrammarExample(text="Siéntese, por favor.", translation="Sit down, please.", note="usted"),
        ],
        common_mistakes=[
            GrammarMistake(wrong="¡Comes más despacio!", correct="¡Come más despacio!", note="El imperativo de tú es \"come\", no \"comes\"."),
            GrammarMistake(wrong="Sentaros aquí.", correct="Sentaos aquí.", note="El imperativo de vosotros pierde la -d delante de \"os\": sentad + os → sentaos."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            ...
            GrammarExample(text="No comáis tantos dulces.", translation="Don't eat so many sweets.", note="vosotros"),
            GrammarExample(text="Por favor, no se preocupe.", translation="Please, don't worry.", note="usted"),
            GrammarExample(text="No lo toques, está caliente.", translation="Don't touch it, it's hot."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="No habla tan alto.", correct="No hables tan alto.", note="El imperativo negativo de tú es \"no hables\", no \"no habla\"."),
            GrammarMistake(wrong="No sentaros aquí.", correct="No os sentéis aquí.", note="En el negativo los pronombres van delante: \"no os sentéis\"."),
        ],
    ...
    GrammarTopic(
        ...
        common_mistakes=[
            GrammarMistake(wrong="Hace los deberes.", correct="Haz los deberes.", note="El imperativo de hacer es \"haz\". \"Hace\" es presente de indicativo."),
            GrammarMistake(wrong="Pone la mesa.", correct="Pon la mesa.", note="El imperativo de poner es \"pon\". \"Pone\" es presente de indicativo."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="El año que viene estudiaré en Granada.", translation="Next year I will study in Granada."),
            GrammarExample(text="¿Vendrás a la boda?", translation="Will you come to the wedding?"),
            GrammarExample(text="No podremos llegar a tiempo.", translation="We won't be able to arrive on time."),
            GrammarExample(text="¿Dónde estará Juan? — Estará en casa.", translation="Where could Juan be? — He's probably at home.", note="conjetura"),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Mañana voy a viajaré.", correct="Mañana viajaré. / Mañana voy a viajar.", note="No mezclar \"ir a\" con el futuro simple; se usa uno u otro."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Me gustaría aprender a tocar la guitarra.", translation="I would like to learn to play the guitar."),
            GrammarExample(text="¿Podrías pasarme la sal?", translation="Could you pass me the salt?"),
            GrammarExample(text="Deberías dormir más horas.", translation="You should sleep more hours."),
            GrammarExample(text="Dijo que llegaría a las ocho.", translation="He said he would arrive at eight."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Si tendría dinero, viajaría.", correct="Si tuviera dinero, viajaría.", note="En las oraciones condicionales con \"si\", el condicional no va en la prótasis."),
            GrammarMistake(wrong="¿Puederías ayudarme?", correct="¿Podrías ayudarme?", note="El condicional de poder es \"podrías\", con -dr-."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Si llueve, no saldremos.", translation="If it rains, we won't go out."),
            GrammarExample(text="Si tienes tiempo, llámame.", translation="If you have time, call me."),
            GrammarExample(text="Te lo compro si no es muy caro.", translation="I'll buy it for you if it isn't very expensive."),
            GrammarExample(text="Si quieres, vamos al cine.", translation="If you want, let's go to the cinema."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Si lloverá, no salgo.", correct="Si llueve, no saldré.", note="Después de \"si\" condicional nunca se usa futuro."),
            GrammarMistake(wrong="Si tendrás tiempo, llámame.", correct="Si tienes tiempo, llámame.", note="\"Si\" no admite futuro ni condicional en la prótasis."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Primero fui al banco, luego pasé por el supermercado y finalmente volví a casa.", translation="First I went to the bank, then I stopped by the supermarket, and finally I went back home."),
            GrammarExample(text="Estaba leyendo cuando de repente se apagó la luz.", translation="I was reading when suddenly the lights went out."),
            GrammarExample(text="Entonces decidí llamar a la policía.", translation="Then I decided to call the police."),
            GrammarExample(text="Al final todo salió bien.", translation="In the end everything turned out fine."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Después fui a su casa.", correct="Después fui a su casa.", note="Correcto. \"Después\" puede ir seguido del verbo directamente o con \"de\" + infinitivo."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Eran las diez de la noche. Llovía con fuerza. De repente, alguien llamó a la puerta.", translation="It was ten at night. It was raining heavily. Suddenly, someone knocked on the door."),
            GrammarExample(text="Mientras desayunaba, leí el periódico.", translation="While I was having breakfast, I read the newspaper."),
            GrammarExample(text="Cuando llegamos al cine, ya había empezado la película.", translation="When we arrived at the cinema, the film had already started."),
            GrammarExample(text="Paseaba por la calle cuando me encontré con un viejo amigo.", translation="I was walking down the street when I ran into an old friend."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Era un día soleado. De repente, alguien llamaba a la puerta.", correct="Era un día soleado. De repente, alguien llamó a la puerta.", note="\"De repente\" introduce una acción puntual; pide indefinido."),
            GrammarMistake(wrong="Cuando llegué, ya cerraron.", correct="Cuando llegué, ya habían cerrado.", note="Acción anterior a otra pasada → pluscuamperfecto."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Dijo que estaba cansado.", translation="He said he was tired.", note="directo: \"Estoy cansado\""),
            GrammarExample(text="Me contó que había vivido en París.", translation="She told me she had lived in Paris.", note="directo: \"He vivido en París\""),
            GrammarExample(text="Aseguró que llegaría al día siguiente.", translation="He assured me he would arrive the next day.", note="directo: \"Llegaré mañana\""),
            GrammarExample(text="Nos explicaron que no podían ayudarnos.", translation="They explained they couldn't help us."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Dijo que está cansado.", correct="Dijo que estaba cansado.", note="Con \"dijo\" (pasado), el verbo subordinado debe concordar en pasado."),
            GrammarMistake(wrong="Dijo que vendrá mañana.", correct="Dijo que vendría al día siguiente.", note="Futuro → condicional, y \"mañana\" → \"al día siguiente\"."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="No salí porque llovía mucho.", translation="I didn't go out because it was raining a lot."),
            GrammarExample(text="Estaba agotado, así que me fui a dormir temprano.", translation="I was exhausted, so I went to bed early."),
            GrammarExample(text="Me gusta el chocolate, pero no debo comer tanto.", translation="I like chocolate, but I shouldn't eat so much."),
            GrammarExample(text="Hizo mucho esfuerzo; sin embargo, no consiguió el puesto.", translation="He made a lot of effort; however, he didn't get the position."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="No es caro, pero barato.", correct="No es caro, sino barato.", note="Tras una negación, para corregir se usa \"sino\", no \"pero\"."),
            GrammarMistake(wrong="No vine por que estaba enfermo.", correct="No vine porque estaba enfermo.", note="\"Porque\" (causa) se escribe junto y sin tilde."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Me dijo que aquel día no podía quedar.", translation="He told me he couldn't meet that day.", note="directo: \"Hoy no puedo quedar\""),
            GrammarExample(text="Aseguró que la semana anterior había estado de vacaciones.", translation="He assured me he had been on holiday the previous week."),
            GrammarExample(text="Comentó que entonces vivía en Barcelona.", translation="He commented that he was living in Barcelona at that time."),
            GrammarExample(text="Explicaron que hacía dos años que no se veían.", translation="They explained they hadn't seen each other for two years."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Dijo que ayer no había podido ir.", correct="Dijo que el día anterior no había podido ir.", note="\"Ayer\" se transforma en \"el día anterior\" al pasar al pasado."),
            GrammarMistake(wrong="Me contó que hoy estaba cansado.", correct="Me contó que aquel día estaba cansado.", note="Referencia temporal debe desplazarse al pasado."),
        ],
