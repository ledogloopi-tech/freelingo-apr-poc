...
A1_GRAMMAR_TOPICS: list[GrammarTopic] = [
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Soy estudiante de español.", translation="I am a Spanish student."),
            ...
            GrammarExample(text="Son las dos y media.", translation="It's two thirty.", note="hora"),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Estoy de Madrid.", correct="Soy de Madrid.", note="\"Ser de\" indica origen. \"Estar\" no se usa para procedencia."),
            GrammarMistake(wrong="Soy un profesor.", correct="Soy profesor.", note="Con profesiones no se usa artículo indefinido salvo que haya adjetivo."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Yo vivo en Barcelona.", translation="I live in Barcelona.", note="énfasis"),
            GrammarExample(text="¿Tú qué opinas?", translation="What do you think?", note="contraste"),
            GrammarExample(text="Ustedes son muy amables.", translation="You are very kind.", note="América Latina"),
            GrammarExample(text="Vosotros tenéis razón.", translation="You are right.", note="España"),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Es de México.", correct="Él es de México. / Es de México.", note="Sin tilde, \"es\" es verbo. Con tilde, \"él\" es pronombre. En contexto suele estar claro."),
            GrammarMistake(wrong="Tú eres de España?", correct="¿Tú eres de España?", note="No olvidar el signo de apertura de interrogación (¿)."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="El libro está en la mesa.", translation="The book is on the table."),
            GrammarExample(text="Los niños juegan en el parque.", translation="The children play in the park."),
            GrammarExample(text="Voy al cine los sábados.", translation="I go to the cinema on Saturdays.", note="contracción al"),
            GrammarExample(text="Lo difícil es empezar.", translation="The hard part is starting.", note="artículo neutro lo"),
        ],
        common_mistakes=[
            GrammarMistake(wrong="El agua está fría.", correct="El agua está fría.", note="Correcto. \"Agua\" es femenino pero usa \"el\" por la a tónica. El adjetivo va en femenino."),
            GrammarMistake(wrong="Voy a el colegio.", correct="Voy al colegio.", note="La contracción \"al\" es obligatoria."),
        ],
    ...
    GrammarTopic(
        ...
        common_mistakes=[
            GrammarMistake(wrong="Estoy de Francia.", correct="Soy de Francia.", note="\"Estar de\" no indica origen. \"Soy de\" es la fórmula correcta."),
            GrammarMistake(wrong="Soy Española.", correct="Soy española.", note="Los adjetivos de nacionalidad van en minúscula."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            ...
            GrammarExample(text="El problema es grave.", translation="The problem is serious.", note="masculino de origen griego"),
            GrammarExample(text="La mano izquierda.", translation="The left hand.", note="excepción: femenino terminado en -o"),
        ],
        common_mistakes=[
            GrammarMistake(wrong="La problema.", correct="El problema.", note="Las palabras de origen griego en -ma son masculinas."),
            GrammarMistake(wrong="El día es bonita.", correct="El día es bonito.", note="\"Día\" es masculino aunque termine en -a. El adjetivo debe concordar."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            ...
            GrammarExample(text="Hay una farmacia cerca.", translation="There's a pharmacy nearby."),
            GrammarExample(text="Tiene unas ideas muy buenas.", translation="She has some very good ideas."),
            GrammarExample(text="Es una arquitecta famosa.", translation="She is a famous architect.", note="con adjetivo, sí lleva artículo"),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Es un profesor.", correct="Es profesor.", note="Sin adjetivo, no se usa artículo con profesiones."),
            GrammarMistake(wrong="Una agua fría.", correct="Un agua fría.", note="\"Agua\" es femenino pero usa \"un\" por la a tónica. El adjetivo va en femenino."),
        ],
    ...
    GrammarTopic(
        ...
        common_mistakes=[
            GrammarMistake(wrong="Soy 20 años.", correct="Tengo 20 años.", note="En español la edad se expresa con \"tener\", no con \"ser\"."),
            GrammarMistake(wrong="Soy hambre.", correct="Tengo hambre.", note="Las sensaciones físicas usan \"tener + sustantivo\", no \"ser\"."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            ...
            GrammarExample(text="Nuestra profesora es de Chile.", translation="Our teacher is from Chile."),
            GrammarExample(text="Sus hijos son muy educados.", translation="Her/His/Their children are very polite.", note="ambiguo"),
        ],
        common_mistakes=[
            GrammarMistake(wrong="La mi mochila.", correct="Mi mochila.", note="En español no se usa artículo con el posesivo antepuesto."),
            GrammarMistake(wrong="Sus libro.", correct="Su libro. / Sus libros.", note="El posesivo concuerda en número con el sustantivo al que acompaña."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            ...
            GrammarExample(text="Es un buen amigo.", translation="He's a good friend.", note="apócope de bueno"),
        ],
        common_mistakes=[
            GrammarMistake(wrong="La casa blanco.", correct="La casa blanca.", note="El adjetivo debe concordar en género: casa (fem.) → blanca (fem.)."),
            GrammarMistake(wrong="Un grande problema.", correct="Un gran problema.", note="\"Grande\" se apocopa a \"gran\" delante de sustantivo singular, masculino o femenino."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Hablo español e inglés.", translation="I speak Spanish and English."),
            ...
            GrammarExample(text="Mis padres no trabajan los fines de semana.", translation="My parents don't work on weekends."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Yo habla español.", correct="Yo hablo español.", note="La primera persona singular termina en -o para las tres conjugaciones."),
            GrammarMistake(wrong="Nosotros comemos juntos?", correct="¿Nosotros comemos juntos?", note="No olvidar el signo ¿ en las preguntas."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            ...
            GrammarExample(text="¿A qué hora te acuestas?", translation="What time do you go to bed?"),
            GrammarExample(text="Nos duchamos por la mañana.", translation="We shower in the morning."),
            GrammarExample(text="Ella se llama Carmen.", translation="Her name is Carmen."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Levanto a las siete.", correct="Me levanto a las siete.", note="No olvidar el pronombre reflexivo."),
            GrammarMistake(wrong="Se llamo Juan.", correct="Me llamo Juan.", note="El pronombre debe concordar con el sujeto: yo → me."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="¿Qué hora es? — Son las tres y media.", translation="What time is it? — It's half past three."),
            GrammarExample(text="La clase empieza a las nueve.", translation="The class starts at nine."),
        ...
        common_mistakes=[
            GrammarMistake(wrong="Son la una y media.", correct="Es la una y media.", note="Con la una se usa \"es\", no \"son\"."),
            GrammarMistake(wrong="A las una.", correct="A la una.", note="La una es singular: \"a la una\", no \"a las una\"."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            ...
            GrammarExample(text="¿Te gustan las películas de terror?", translation="Do you like horror movies?"),
            GrammarExample(text="A ella le gusta viajar.", translation="She likes to travel."),
            GrammarExample(text="Nos encanta la música latina.", translation="We love Latin music.", note="misma estructura que gustar"),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Yo gusto el café.", correct="Me gusta el café. / A mí me gusta el café.", note="\"Gustar\" no se conjuga como \"to like\". El sujeto es \"el café\"."),
            GrammarMistake(wrong="Me gustan bailar.", correct="Me gusta bailar.", note="Con infinitivo, el verbo gustar va en singular."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="— Me gusta leer. — A mí también.", translation="\"I like reading.\" \"Me too.\""),
            GrammarExample(text="— No he ido al cine. — Yo tampoco.", translation="\"I haven't been to the cinema.\" \"Me neither.\""),
            GrammarExample(text="Ella también habla francés.", translation="She also speaks French."),
            GrammarExample(text="Él tampoco sabe la respuesta.", translation="He doesn't know the answer either."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Yo no tampoco.", correct="Yo tampoco.", note="\"Tampoco\" ya incluye la negación; no se necesita \"no\"."),
            GrammarMistake(wrong="— No me gusta. — Yo también.", correct="— No me gusta. — A mí tampoco.", note="Para coincidir en una negación se usa \"tampoco\", no \"también\"."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="La película es muy interesante.", translation="The film is very interesting."),
            GrammarExample(text="Tengo mucha hambre.", translation="I am very hungry."),
            GrammarExample(text="Estudia mucho todos los días.", translation="He studies a lot every day."),
            GrammarExample(text="Este diccionario es mucho mejor.", translation="This dictionary is much better.", note="comparativo"),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Estoy mucho cansado.", correct="Estoy muy cansado.", note="Con adjetivos se usa \"muy\", no \"mucho\"."),
            GrammarMistake(wrong="Tengo muy dinero.", correct="Tengo mucho dinero.", note="Con sustantivos se usa \"mucho\", no \"muy\"."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="¿Dónde está el supermercado?", translation="Where is the supermarket?"),
            GrammarExample(text="Estoy muy contento hoy.", translation="I am very happy today."),
            GrammarExample(text="Estamos aprendiendo español.", translation="We are learning Spanish."),
            GrammarExample(text="La puerta está abierta.", translation="The door is open."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Soy en la oficina.", correct="Estoy en la oficina.", note="Para ubicación se usa \"estar\", no \"ser\"."),
            GrammarMistake(wrong="La fiesta está en el salón.", correct="La fiesta es en el salón.", note="Para eventos se usa \"ser\", no \"estar\"."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Hay una farmacia en la esquina.", translation="There's a pharmacy on the corner."),
            GrammarExample(text="¿Hay leche en la nevera?", translation="Is there milk in the fridge?"),
            GrammarExample(text="No hay muchas opciones.", translation="There aren't many options."),
            GrammarExample(text="En el parque hay niños jugando.", translation="There are children playing in the park."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Hayn muchos coches.", correct="Hay muchos coches.", note="\"Hay\" es invariable; no existe la forma \"hayn\"."),
            GrammarMistake(wrong="Ahí un problema.", correct="Hay un problema.", note="\"Ahí\" es adverbio de lugar; \"hay\" es la forma impersonal de haber."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="El gato está debajo de la mesa.", translation="The cat is under the table."),
            GrammarExample(text="Hay un parque detrás del colegio.", translation="There is a park behind the school."),
            GrammarExample(text="Mi casa está entre la farmacia y el banco.", translation="My house is between the pharmacy and the bank."),
            GrammarExample(text="Las llaves están dentro del bolso.", translation="The keys are inside the bag."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Está al lado la puerta.", correct="Está al lado de la puerta.", note="Las preposiciones compuestas necesitan \"de\": al lado de, encima de, debajo de."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Voy a estudiar medicina.", translation="I am going to study medicine."),
            GrammarExample(text="¿Vas a venir a la fiesta?", translation="Are you going to come to the party?"),
            GrammarExample(text="Ellos van a viajar a México este verano.", translation="They are going to travel to Mexico this summer."),
            GrammarExample(text="Va a llover, mira las nubes.", translation="It's going to rain, look at the clouds."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Voy estudiar.", correct="Voy a estudiar.", note="Entre \"ir\" y el infinitivo se necesita la preposición \"a\"."),
            GrammarMistake(wrong="Vamos a la playa mañana.", correct="Vamos a ir a la playa mañana.", note="Para planes futuros se necesita \"ir a + infinitivo\"."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Quiero viajar a Argentina.", translation="I want to travel to Argentina."),
            GrammarExample(text="¿Puedes ayudarme?", translation="Can you help me?"),
            GrammarExample(text="No podemos salir esta noche.", translation="We can't go out tonight."),
            GrammarExample(text="Ella quiere ser profesora.", translation="She wants to be a teacher."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Quiero a comer.", correct="Quiero comer.", note="Los verbos modales en español NO llevan preposición antes del infinitivo."),
            GrammarMistake(wrong="¿Puedo de entrar?", correct="¿Puedo entrar?", note="\"Poder\" rige infinitivo directamente, sin \"de\" ni \"a\"."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="El martes tengo una reunión.", translation="On Tuesday I have a meeting."),
            GrammarExample(text="Los domingos descansamos.", translation="On Sundays we rest."),
            GrammarExample(text="Mi cumpleaños es en abril.", translation="My birthday is in April."),
            GrammarExample(text="Estudio español por las mañanas.", translation="I study Spanish in the mornings."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="En Lunes voy al gimnasio.", correct="El lunes voy al gimnasio.", note="Con días de la semana se usa \"el\", no \"en\"."),
            GrammarMistake(wrong="Trabajo los Martes.", correct="Trabajo los martes.", note="Los días de la semana se escriben con minúscula."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Este libro es muy interesante.", translation="This book is very interesting.", note="cerca del hablante"),
            GrammarExample(text="Esa casa de ahí es de mi tía.", translation="That house over there is my aunt's.", note="distancia media"),
            GrammarExample(text="Aquel edificio es el más alto de la ciudad.", translation="That building over there is the tallest in the city.", note="lejos de ambos"),
            GrammarExample(text="¿Qué es esto?", translation="What is this?", note="forma neutra"),
            GrammarExample(text="Eso que me cuentas es increíble.", translation="What you're telling me is incredible.", note="neutro para referirse a una idea"),
        ],
        common_mistakes=[
            GrammarMistake(wrong="La este calle es muy ancha.", correct="Esta calle es muy ancha.", note="El demostrativo no lleva artículo delante."),
            GrammarMistake(wrong="No me gusta este.", correct="No me gusta esto.", note="Usa la forma neutra \"esto\" para referirse a una situación o idea, no \"este\"."),
            GrammarMistake(wrong="Éste es mi coche.", correct="Este es mi coche.", note="Desde 2010, la RAE recomienda no tildar los pronombres demostrativos."),
        ],
