...
B2_GRAMMAR_TOPICS: list[GrammarTopic] = [
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Si tuviera/tuviese más tiempo, viajaría más.", translation="If I had more time, I would travel more."),
            GrammarExample(text="Me pidió que hablara/hablase más despacio.", translation="He asked me to speak more slowly."),
            GrammarExample(text="Ojalá lloviera/lloviese mañana.", translation="I wish it would rain tomorrow."),
            GrammarExample(text="Era importante que llegáramos/llegásemos a tiempo.", translation="It was important that we arrived on time."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Si tendría tiempo, viajaría.", correct="Si tuviera/tuviese tiempo, viajaría.", note="Después de \"si\" condicional se usa imperfecto de subjuntivo, no condicional."),
            GrammarMistake(wrong="Me pidió que hable más despacio.", correct="Me pidió que hablara/hablase más despacio.", note="Con verbo introductor en pasado se usa imperfecto de subjuntivo."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Si hubiera sabido que venías, te habría esperado.", translation="If I had known you were coming, I would have waited for you."),
            GrammarExample(text="Ojalá hubiera estudiado español de niño.", translation="I wish I had studied Spanish as a child."),
            GrammarExample(text="Me habría gustado que hubieras venido a la boda.", translation="I would have liked you to have come to the wedding."),
            GrammarExample(text="Si no hubiese llovido, habríamos ido a la playa.", translation="If it hadn't rained, we would have gone to the beach."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Si habría sabido, habría ido.", correct="Si hubiera/hubiese sabido, habría ido.", note="En la prótasis con \"si\" se usa pluscuamperfecto de subjuntivo, no condicional."),
            GrammarMistake(wrong="Ojalá he ido al concierto.", correct="Ojalá hubiera/hubiese ido al concierto.", note="Deseo sobre pasado incumplido requiere pluscuamperfecto de subjuntivo."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Quiero que termines el trabajo hoy.", translation="I want you to finish the work today.", note="presente → presente subj."),
            GrammarExample(text="Quería que terminaras el trabajo aquel día.", translation="I wanted you to finish the work that day.", note="pasado → imperfecto subj."),
            GrammarExample(text="No creo que haya llegado todavía.", translation="I don't think he has arrived yet.", note="presente → perfecto subj."),
            GrammarExample(text="No creía que hubiera llegado todavía.", translation="I didn't think he had arrived yet.", note="pasado → pluscuamperfecto subj."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Quería que vengas.", correct="Quería que vinieras.", note="Con verbo principal en pasado, la subordinada debe ir en imperfecto de subjuntivo."),
            GrammarMistake(wrong="Espero que vinieras ayer.", correct="Espero que hayas venido ayer. / Esperaba que vinieras ayer.", note="Si el principal está en presente, la acción pasada inmediata va en perfecto de subjuntivo."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Acabo de enterarme de la noticia.", translation="I just found out the news."),
            GrammarExample(text="Llevamos dos horas esperando.", translation="We've been waiting for two hours."),
            GrammarExample(text="Sigue trabajando en el mismo sitio.", translation="He keeps working at the same place."),
            GrammarExample(text="Está a punto de empezar la película.", translation="The film is about to start."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Acabo llegar.", correct="Acabo de llegar.", note="\"Acabar\" en perífrasis lleva \"de\"."),
            GrammarMistake(wrong="Empecé estudiar.", correct="Empecé a estudiar.", note="\"Empezar\" en perífrasis lleva \"a\"."),
            GrammarMistake(wrong="Anda diciendo mentiras.", correct="Anda diciendo mentiras.", note="Correcto. \"Andar + gerundio\" es coloquial para acciones intermitentes."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Tienes que ver esta película, es genial.", translation="You have to see this film, it's great."),
            GrammarExample(text="Hay que reciclar para proteger el medio ambiente.", translation="One must recycle to protect the environment."),
            GrammarExample(text="Deben de estar dormidos, no contestan.", translation="They must be asleep, they don't answer.", note="conjetura"),
            GrammarExample(text="No hace falta que vengas tan temprano.", translation="You don't need to come so early."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Hay que reciclar.", correct="Hay que reciclar.", note="Correcto. \"Hay que\" es impersonal; no se conjuga para personas específicas."),
            GrammarMistake(wrong="Deben de llegar temprano mañana.", correct="Deben llegar temprano mañana.", note="Para obligación: \"deber + infinitivo\". \"Deber de\" es conjetura."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Dejé de comer carne hace un año.", translation="I stopped eating meat a year ago."),
            GrammarExample(text="Sigo pensando que tienes razón.", translation="I still think you're right."),
            GrammarExample(text="No dejes de practicar español todos los días.", translation="Don't stop practicing Spanish every day."),
            GrammarExample(text="Continuaron hablando hasta muy tarde.", translation="They kept talking until very late."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Dejé fumar.", correct="Dejé de fumar.", note="\"Dejar\" con sentido de cesar necesita \"de\"."),
            GrammarMistake(wrong="Sigo a trabajar aquí.", correct="Sigo trabajando aquí.", note="\"Seguir\" con sentido de continuar rige gerundio sin preposición."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="El proyecto es ambicioso; no obstante, confiamos en su éxito.", translation="The project is ambitious; nevertheless, we trust in its success."),
            GrammarExample(text="A mí me encanta el campo. Mi hermana, en cambio, prefiere la ciudad.", translation="I love the countryside. My sister, on the other hand, prefers the city."),
            GrammarExample(text="No se presentaron pruebas; por consiguiente, el caso fue desestimado.", translation="No evidence was presented; consequently, the case was dismissed."),
            GrammarExample(text="Los resultados han sido positivos. En efecto, hemos superado las expectativas.", translation="The results have been positive. Indeed, we have exceeded expectations."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="No obstante, de la lluvia, salimos.", correct="A pesar de la lluvia, salimos. / Llovía; no obstante, salimos.", note="\"No obstante\" es conector oracional, no preposición."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Compré un libro. Lo estoy leyendo ahora.", translation="I bought a book. I'm reading it now.", note="anáfora: lo → libro"),
            GrammarExample(text="Te lo repito: no voy a ir.", translation="I repeat it to you: I'm not going.", note="catáfora: lo anticipa \"no voy a ir\""),
            GrammarExample(text="El león es un felino. Este animal vive en la sabana.", translation="The lion is a feline. This animal lives in the savannah.", note="sustitución léxica"),
            GrammarExample(text="— ¿Vas a venir? — Sí.", translation="\"Are you coming?\" \"Yes.\"", note="elipsis: se omite \"voy a venir\""),
        ],
        common_mistakes=[
            GrammarMistake(wrong="María y Ana fueron. Ella llegó tarde.", correct="María y Ana fueron. María/Ana llegó tarde.", note="Cuando hay ambigüedad, es mejor repetir el nombre que usar un pronombre poco claro."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="¿Podría indicarme dónde está la estación?", translation="Could you tell me where the station is?", note="formal"),
            GrammarExample(text="Oye, ¿sabes dónde está la estación?", translation="Hey, do you know where the station is?", note="coloquial"),
            GrammarExample(text="Le agradecería que me enviara la documentación.", translation="I would appreciate it if you sent me the documentation.", note="formal"),
            GrammarExample(text="Mándame los papeles cuando puedas.", translation="Send me the papers when you can.", note="coloquial"),
        ],
        common_mistakes=[
            GrammarMistake(wrong="¿Puedes decirme la hora, señor director?", correct="¿Podría decirme la hora, señor director?", note="Con un superior o en contexto formal, se usa \"usted\" y formas de cortesía."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Ese coche cuesta un ojo de la cara.", translation="That car costs an arm and a leg."),
            GrammarExample(text="Metí la pata al decirle su edad.", translation="I put my foot in it by telling him his age."),
            GrammarExample(text="El examen fue pan comido.", translation="The exam was a piece of cake."),
            GrammarExample(text="¿Me echas una mano con las cajas?", translation="Can you give me a hand with the boxes?"),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Esa casa cuesta un ojo.", correct="Esa casa cuesta un ojo de la cara.", note="El modismo completo es \"costar un ojo de la cara\"."),
            GrammarMistake(wrong="Puse la pata.", correct="Metí la pata.", note="El modismo es \"meter la pata\", no \"poner la pata\"."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Pues... no sé qué decirte.", translation="Well... I don't know what to tell you."),
            GrammarExample(text="O sea, que al final no vienes.", translation="So, in the end you're not coming."),
            GrammarExample(text="¡Qué guay! Me encanta tu casa nueva.", translation="How cool! I love your new house.", note="España"),
            GrammarExample(text="Estaba en plan \"no me hables\" y yo en plan \"pues vale\".", translation="He was like \"don't talk to me\" and I was like \"whatever\".", note="muy coloquial"),
        ],
        common_mistakes=[
            GrammarMistake(wrong="¡Qué guay! Me encanta tu casa.", correct="¡Qué guay! / ¡Qué chévere! / ¡Qué padre!", note="Correcto en España. En Latinoamérica usar expresiones locales equivalentes."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="A quien madruga, Dios le ayuda.", translation="The early bird catches the worm."),
            GrammarExample(text="Más vale tarde que nunca.", translation="Better late than never."),
            GrammarExample(text="No hay mal que por bien no venga.", translation="Every cloud has a silver lining."),
            GrammarExample(text="En boca cerrada no entran moscas.", translation="Silence is golden."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Más vale pájaro que cien volando.", correct="Más vale pájaro en mano que ciento volando.", note="La forma correcta incluye \"en mano\" para contrastar lo seguro con lo incierto."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="En mi opinión, estudiar idiomas desde pequeños es fundamental. En primer lugar, los niños tienen mayor plasticidad cerebral. Además, adquirir una segunda lengua favorece el desarrollo cognitivo.", translation="In my opinion, learning languages from an early age is essential. First, children have greater brain plasticity. Moreover, acquiring a second language favors cognitive development."),
            GrammarExample(text="Hay quienes opinan que la tecnología aísla a las personas. No obstante, bien utilizada, facilita la comunicación y acerca a quienes están lejos.", translation="Some people think that technology isolates people. However, when used well, it facilitates communication and brings closer those who are far away."),
        ],
        common_mistakes=[
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Aunque es cierto que las redes sociales pueden ser adictivas, su uso responsable ofrece grandes beneficios educativos y sociales.", translation="Although it's true that social media can be addictive, its responsible use offers great educational and social benefits."),
            GrammarExample(text="Reconozco que la medida es costosa. Sin embargo, los beneficios a largo plazo justifican la inversión.", translation="I acknowledge that the measure is expensive. However, the long-term benefits justify the investment."),
        ],
        common_mistakes=[
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Quizás deberíamos considerar otras opciones.", translation="Perhaps we should consider other options.", note="atenuador"),
            GrammarExample(text="Sin duda, este es el mejor restaurante de la ciudad.", translation="Without a doubt, this is the best restaurant in the city.", note="intensificador"),
            GrammarExample(text="Me parece que no es la mejor solución.", translation="I think it's not the best solution.", note="atenuador"),
            GrammarExample(text="Está claro que tenemos que actuar ya.", translation="It's clear that we have to act now.", note="intensificador"),
        ],
        common_mistakes=[
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Era una noche oscura. El viento soplaba con fuerza. De repente, escuché un ruido. Alguien había entrado en la casa.", translation="It was a dark night. The wind was blowing hard. Suddenly, I heard a noise. Someone had entered the house."),
            GrammarExample(text="Napoleón nace en Córcega en 1769. A los dieciséis años ingresa en la academia militar.", translation="Napoleon is born in Corsica in 1769. At sixteen he enters the military academy.", note="presente histórico"),
        ],
        common_mistakes=[
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="El sol se ocultaba tras las montañas, tiñendo el cielo de tonos anaranjados y violetas. Una brisa cálida mecía las hojas de las palmeras.", translation="The sun was setting behind the mountains, dyeing the sky with orange and violet tones. A warm breeze swayed the palm leaves."),
            GrammarExample(text="Era una mujer alta, de andar pausado y mirada serena. Su voz, grave y melodiosa, inspiraba confianza.", translation="She was a tall woman, with a slow walk and a serene gaze. Her voice, deep and melodious, inspired trust."),
        ],
        common_mistakes=[
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Está que echa chispas.", translation="He's fuming.", note="metáfora coloquial"),
            GrammarExample(text="El tiempo es oro.", translation="Time is gold/money.", note="metáfora"),
            GrammarExample(text="Eres más lento que una tortuga.", translation="You're slower than a turtle.", note="símil"),
            GrammarExample(text="Las estrellas nos miraban desde el cielo.", translation="The stars were watching us from the sky.", note="personificación"),
        ],
        common_mistakes=[
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Aprobada la nueva ley de educación tras un intenso debate parlamentario.", translation="New education law approved after intense parliamentary debate.", note="titular: participio + sujeto"),
            GrammarExample(text="Según fuentes cercanas al gobierno, la medida se anunciará la próxima semana.", translation="According to sources close to the government, the measure will be announced next week."),
        ],
        common_mistakes=[
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Rescatados diez inmigrantes en la costa de Almería.", translation="Ten immigrants rescued off the coast of Almería.", note="participio suelto"),
            GrammarExample(text="Sanidad: la espera media para una operación baja a 90 días.", translation="Healthcare: the average wait for an operation drops to 90 days.", note="dos puntos"),
            GrammarExample(text="Aumentar el salario mínimo un 5% el próximo año.", translation="Minimum wage to increase by 5% next year.", note="infinitivo de futuro"),
        ],
        common_mistakes=[
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="El ministro aseguró que las medidas \"darán resultados en el corto plazo\".", translation="The minister assured that the measures \"will yield results in the short term\"."),
            GrammarExample(text="Según testigos presenciales, el incendio comenzó sobre las tres de la madrugada.", translation="According to eyewitnesses, the fire started around three in the morning."),
            GrammarExample(text="\"No vamos a tolerar la violencia\", recalcó el alcalde.", translation="\"We will not tolerate violence,\" the mayor emphasized."),
        ],
        common_mistakes=[
        ],
        related=["lenguaje-periodistico", "titulares", "estilo-indirecto", "estilo-indirecto-pasado"],
    ),
]
