...
B1_GRAMMAR_TOPICS: list[GrammarTopic] = [
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Quiero que vengas a mi fiesta.", translation="I want you to come to my party."),
            GrammarExample(text="Espero que tengas un buen viaje.", translation="I hope you have a good trip."),
            GrammarExample(text="No creo que sea buena idea.", translation="I don't think it's a good idea."),
            GrammarExample(text="Dudo que llueva hoy.", translation="I doubt it will rain today."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Quiero que vienes.", correct="Quiero que vengas.", note="Con \"querer que\" se usa subjuntivo, no indicativo."),
            GrammarMistake(wrong="Espero que tienes un buen día.", correct="Espero que tengas un buen día.", note="\"Esperar que\" rige subjuntivo."),
        ],
        related=["expresiones-deseo", "ojala", "subjuntivo-recomendacion", "subjuntivo-duda", "subjuntivo-valoracion"],
    ),
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Espero que te guste el regalo.", translation="I hope you like the present."),
            GrammarExample(text="Mis padres quieren que estudie medicina.", translation="My parents want me to study medicine."),
            GrammarExample(text="Necesito que me ayudes con esto.", translation="I need you to help me with this."),
            GrammarExample(text="Prefiero que vengáis mañana.", translation="I prefer you to come tomorrow."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Espero que te gusta.", correct="Espero que te guste.", note="\"Esperar que\" rige subjuntivo, no indicativo."),
            GrammarMistake(wrong="Quiero que yo vaya.", correct="Quiero ir.", note="Cuando el sujeto es el mismo, se usa infinitivo."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Ojalá pueda ir a tu boda.", translation="I hope I can go to your wedding."),
            GrammarExample(text="Ojalá no llueva durante las vacaciones.", translation="Let's hope it doesn't rain during the holidays."),
            GrammarExample(text="Ojalá tuviera más dinero.", translation="I wish I had more money.", note="deseo difícil"),
            GrammarExample(text="Ojalá hubiera aprendido español de niño.", translation="I wish I had learned Spanish as a child.", note="deseo irreal sobre el pasado"),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Ojalá tengo tiempo.", correct="Ojalá tenga tiempo.", note="\"Ojalá\" siempre rige subjuntivo."),
            GrammarMistake(wrong="Ojalá que vendrá.", correct="Ojalá que venga.", note="No se usa futuro con \"ojalá\"."),
        ],
        related=["expresiones-deseo", "subjuntivo-presente", "subjuntivo-imperfecto", "pluscuamperfecto"],
    ),
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Te recomiendo que visites Granada.", translation="I recommend you visit Granada."),
            GrammarExample(text="Es importante que bebas mucha agua en verano.", translation="It's important that you drink a lot of water in summer."),
            GrammarExample(text="Sugiero que lleguéis media hora antes.", translation="I suggest you arrive half an hour early."),
            GrammarExample(text="Conviene que reserves con antelación.", translation="It's advisable that you book in advance."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Recomiendo que visitas Granada.", correct="Recomiendo que visites Granada.", note="\"Recomendar que\" rige subjuntivo."),
            GrammarMistake(wrong="Es importante que llegas puntual.", correct="Es importante que llegues puntual.", note="Las expresiones impersonales de influencia rigen subjuntivo."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="No creo que él tenga razón.", translation="I don't think he's right."),
            GrammarExample(text="Dudo que puedan terminar a tiempo.", translation="I doubt they can finish on time."),
            GrammarExample(text="Es posible que llueva mañana.", translation="It's possible that it will rain tomorrow."),
            GrammarExample(text="Quizás vayamos a la playa este fin de semana.", translation="Maybe we'll go to the beach this weekend."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="No creo que tiene razón.", correct="No creo que tenga razón.", note="\"No creer que\" rige subjuntivo, no indicativo."),
            GrammarMistake(wrong="Dudo que viene.", correct="Dudo que venga.", note="\"Dudar que\" siempre rige subjuntivo."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Me alegra que hayas encontrado trabajo.", translation="I'm glad you've found a job."),
            GrammarExample(text="Es increíble que no lo sepas.", translation="It's incredible that you don't know it."),
            GrammarExample(text="Siento que no puedas venir a la boda.", translation="I'm sorry you can't come to the wedding."),
            GrammarExample(text="Es normal que estés cansado después del viaje.", translation="It's normal that you're tired after the trip."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Me alegra que estás aquí.", correct="Me alegra que estés aquí.", note="Las expresiones de emoción rigen subjuntivo."),
            GrammarMistake(wrong="Es bueno que haces ejercicio.", correct="Es bueno que hagas ejercicio.", note="\"Es bueno que\" rige subjuntivo."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            ...
            GrammarExample(text="¿Has estado alguna vez en México?", translation="Have you ever been to Mexico?"),
            GrammarExample(text="Todavía no hemos terminado el proyecto.", translation="We haven't finished the project yet."),
            GrammarExample(text="Ya he visto esa película.", translation="I've already seen that film."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="He visto la película ayer.", correct="Ayer vi la película.", note="Con \"ayer\" (periodo terminado) se usa indefinido, no perfecto."),
            GrammarMistake(wrong="Han rompido la ventana.", correct="Han roto la ventana.", note="El participio de romper es \"roto\", irregular."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Cuando llegué al cine, la película ya había empezado.", translation="When I arrived at the cinema, the film had already started."),
            GrammarExample(text="Nunca había visto algo tan bonito.", translation="I had never seen something so beautiful."),
            GrammarExample(text="No habían terminado los deberes cuando llegó su madre.", translation="They hadn't finished their homework when their mother arrived."),
            GrammarExample(text="Me dijo que ya había estado en ese restaurante.", translation="He told me he had already been to that restaurant."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Cuando llegué, ya empezó la película.", correct="Cuando llegué, ya había empezado la película.", note="Acción anterior a otra pasada requiere pluscuamperfecto."),
            GrammarMistake(wrong="Nunca he visto algo tan bonito hasta ese día.", correct="Nunca había visto algo tan bonito hasta ese día.", note="Hasta un momento pasado se usa pluscuamperfecto, no perfecto."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Esta semana he ido al gimnasio tres veces.", translation="This week I've gone to the gym three times."),
            GrammarExample(text="¿Alguna vez has probado el ceviche?", translation="Have you ever tried ceviche?"),
            GrammarExample(text="Todavía no he encontrado las llaves.", translation="I still haven't found the keys."),
            GrammarExample(text="Últimamente no hemos tenido mucho trabajo.", translation="Lately we haven't had much work."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Hoy fui al médico.", correct="Hoy he ido al médico.", note="Con \"hoy\" (periodo no terminado) en España se prefiere el perfecto. En América se usa también el indefinido."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="El edificio fue diseñado por un arquitecto famoso.", translation="The building was designed by a famous architect."),
            GrammarExample(text="Las cartas serán enviadas mañana.", translation="The letters will be sent tomorrow."),
            GrammarExample(text="La decisión ha sido tomada por el comité.", translation="The decision has been made by the committee."),
            GrammarExample(text="Los ladrones fueron detenidos por la policía.", translation="The thieves were arrested by the police."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="La cena fue preparado por el chef.", correct="La cena fue preparada por el chef.", note="El participio debe concordar con el sujeto paciente (cena, femenino)."),
            GrammarMistake(wrong="El libro está escrito por Cervantes.", correct="El libro fue escrito por Cervantes.", note="\"Estar + participio\" indica resultado; \"ser + participio\" indica proceso/agente."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Se habla inglés en la recepción.", translation="English is spoken at the reception."),
            GrammarExample(text="Se come muy bien en este restaurante.", translation="One eats very well in this restaurant."),
            GrammarExample(text="Se necesita camarero.", translation="Waiter needed."),
            GrammarExample(text="Se busca a los criminales.", translation="The criminals are being searched for."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Se venden coches aquí.", correct="Se venden coches aquí.", note="Esta es pasiva refleja (concordancia). La impersonal sería \"Se vende coches\" (menos frecuente)."),
            GrammarMistake(wrong="Se busca los documentos.", correct="Se buscan los documentos.", note="Con cosa se suele usar pasiva refleja con concordancia: se buscan."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            ...
            GrammarExample(text="Aquí se hablan varios idiomas.", translation="Several languages are spoken here."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Se vende flores.", correct="Se venden flores.", note="El verbo debe concordar en número con el sujeto (flores, plural)."),
            GrammarMistake(wrong="Se alquila apartamentos.", correct="Se alquilan apartamentos.", note="En la pasiva refleja hay concordancia de número."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="La chica que conocí ayer es italiana.", translation="The girl I met yesterday is Italian."),
            GrammarExample(text="El coche que compré es eléctrico.", translation="The car I bought is electric."),
            GrammarExample(text="Lo que me contaste es increíble.", translation="What you told me is incredible."),
            GrammarExample(text="La ciudad en que vivo es muy tranquila.", translation="The city where I live is very quiet."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="La ciudad que vivo es tranquila.", correct="La ciudad en que vivo es tranquila. / La ciudad donde vivo es tranquila.", note="Con complemento de lugar se necesita preposición o usar \"donde\"."),
            GrammarMistake(wrong="El chico cual vino ayer.", correct="El chico que vino ayer.", note="\"El cual\" no se usa como sujeto de oraciones especificativas."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="El bar donde quedamos está en el centro.", translation="The bar where we're meeting is downtown."),
            GrammarExample(text="Volveré a la ciudad donde crecí.", translation="I'll return to the city where I grew up."),
            GrammarExample(text="Llegó justo cuando empezábamos a comer.", translation="He arrived just when we were starting to eat."),
            GrammarExample(text="Cuando termines, avísame.", translation="When you finish, let me know."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="La ciudad adonde vivo.", correct="La ciudad donde vivo. / La ciudad en la que vivo.", note="\"Adonde\" implica dirección (ir a); para ubicación se usa \"donde\" o \"en donde\"."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="El autor cuyo libro leí ayer es argentino.", translation="The author whose book I read yesterday is Argentine."),
            GrammarExample(text="La ciudad cuyas calles son tan estrechas es Toledo.", translation="The city whose streets are so narrow is Toledo."),
            GrammarExample(text="Es una persona de cuya honestidad no dudo.", translation="He is a person whose honesty I don't doubt."),
            GrammarExample(text="Los estudiantes cuyos trabajos fueron seleccionados recibirán un premio.", translation="The students whose works were selected will receive a prize."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="El escritor cuyo su libro es famoso.", correct="El escritor cuyo libro es famoso.", note="\"Cuyo\" ya incluye el valor posesivo; \"su\" es redundante."),
            GrammarMistake(wrong="La chica cuya el padre es médico.", correct="La chica cuyo padre es médico.", note="\"Cuyo\" concuerda con \"padre\" (masc.), no con \"chica\". No lleva artículo."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Si me lo hubieras dicho, te habría ayudado.", translation="If you had told me, I would have helped you."),
            GrammarExample(text="No contestan. Se habrían ido ya.", translation="They don't answer. They must have left already.", note="conjetura"),
            GrammarExample(text="Habrías disfrutado mucho en la fiesta.", translation="You would have enjoyed the party a lot."),
            GrammarExample(text="Dijo que para entonces ya habría llegado.", translation="He said that by then he would have already arrived."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Si habrías estudiado, habrías aprobado.", correct="Si hubieras estudiado, habrías aprobado.", note="En la prótasis con \"si\" nunca se usa condicional."),
            GrammarMistake(wrong="Habría ido si tenía tiempo.", correct="Habría ido si hubiera tenido tiempo.", note="Condición irreal pasada pide pluscuamperfecto de subjuntivo."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Si tuviera más tiempo, aprendería francés.", translation="If I had more time, I would learn French."),
            GrammarExample(text="Si fueras más alto, podrías jugar al baloncesto.", translation="If you were taller, you could play basketball."),
            GrammarExample(text="Me compraría esa casa si no fuera tan cara.", translation="I would buy that house if it weren't so expensive."),
            GrammarExample(text="Si vivieras aquí, nos veríamos más a menudo.", translation="If you lived here, we would see each other more often."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Si tendría dinero, viajaría.", correct="Si tuviera/tuviese dinero, viajaría.", note="En la prótasis se usa subjuntivo, no condicional."),
            GrammarMistake(wrong="Si yo sería tú, estudiaría más.", correct="Si yo fuera tú, estudiaba más. / Yo que tú, estudiaría más.", note="\"Si yo fuera\" es la forma correcta, con imperfecto de subjuntivo de ser."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Estará en el trabajo, no contesta el móvil.", translation="He's probably at work, he doesn't answer his phone."),
            GrammarExample(text="No sé qué le pasaba; tendría un mal día.", translation="I don't know what was wrong with him; he was probably having a bad day."),
            GrammarExample(text="A lo mejor llueve mañana.", translation="Maybe it will rain tomorrow."),
            GrammarExample(text="Es probable que lleguen tarde.", translation="They will probably arrive late."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Es probable que llegan tarde.", correct="Es probable que lleguen tarde.", note="\"Es probable que\" rige subjuntivo."),
            GrammarMistake(wrong="A lo mejor venga.", correct="A lo mejor viene.", note="\"A lo mejor\" siempre rige indicativo."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Me dijo que había estado en Madrid el verano anterior.", translation="He told me he had been in Madrid the previous summer."),
            GrammarExample(text="Preguntó si íbamos a venir a la cena.", translation="He asked if we were going to come to the dinner."),
            GrammarExample(text="Me pidió que le ayudara con la mudanza.", translation="He asked me to help him with the move.", note="imperativo → subjuntivo"),
            GrammarExample(text="Explicó que para entonces ya habrían terminado.", translation="He explained that by then they would have already finished."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Dijo que ha ido al médico ayer.", correct="Dijo que había ido al médico el día anterior.", note="Con verbo introductor en pasado, el perfecto pasa a pluscuamperfecto."),
            GrammarMistake(wrong="Me pidió que le ayudo.", correct="Me pidió que le ayudara/ayudase.", note="Petición en pasado → imperfecto de subjuntivo."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Estudio español para viajar por Latinoamérica.", translation="I study Spanish (in order) to travel around Latin America.", note="para = finalidad; por = lugar aproximado"),
            GrammarExample(text="Gracias por todo. El regalo es para ti.", translation="Thanks for everything. The gift is for you.", note="por = causa de agradecimiento; para = destinatario"),
            GrammarExample(text="Pasé por tu oficina pero no estabas.", translation="I passed by your office but you weren't there.", note="lugar aproximado"),
            GrammarExample(text="Este informe es para el viernes.", translation="This report is for Friday.", note="plazo límite"),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Gracias para la invitación.", correct="Gracias por la invitación.", note="Con \"gracias\" se usa \"por\", no \"para\"."),
            GrammarMistake(wrong="Estudio por ser médico.", correct="Estudio para ser médico.", note="\"Para\" + infinitivo expresa el propósito de la acción."),
            GrammarMistake(wrong="El puente fue construido para los romanos.", correct="El puente fue construido por los romanos.", note="El agente de la voz pasiva se introduce con \"por\"."),
        ],
