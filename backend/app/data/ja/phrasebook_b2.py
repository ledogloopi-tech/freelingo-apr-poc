...
B2_CATEGORIES: list[PhrasebookCategory] = [
    ...
    PhrasebookCategory(
        ...
        phrases=[
            ...
            _p('この点について補足してもよろしいでしょうか。', '補足を申し出る', 'formal', 'b2-unit-1'),
    ...
    PhrasebookCategory(
        ...
        phrases=[
            ...
            _p('この結論は少し飛躍していると思います。', '論理の弱点を指摘する', 'neutral', 'b2-unit-5'),
    ...
    PhrasebookCategory(
        ...
        phrases=[
            ...
            _p('専門家の意見も確認したほうがいいです。', '追加情報を求める', 'neutral', 'b2-unit-2'),
            _p('統計の取り方に注意が必要です。', 'データの扱いを指摘する', 'formal', 'b2-unit-2'),
            _p('報道の仕方によって印象が変わります。', 'メディア表現を分析する', 'neutral', 'b2-unit-2'),
    ...
    PhrasebookCategory(
        ...
        phrases=[
            ...
            _p('期限に間に合わせるには人員が必要です。', 'リソース不足を伝える', 'formal', 'b2-unit-1'),
            _p('品質を保つために確認工程を増やします。', '品質管理を説明する', 'formal', 'b2-unit-1'),
    ...
    PhrasebookCategory(
        ...
        icon='📈',
        phrases=[
            _p('現状を踏まえると、段階的な導入が現実的です。', '現実的な提案をする', 'formal', 'b2-unit-1'),
            _p('費用対効果を確認してから判断しましょう。', '判断基準を示す', 'formal', 'b2-unit-6'),
            _p('顧客への影響を最優先に考える必要があります。', '優先事項を述べる', 'formal', 'b2-unit-1'),
            _p('この施策には短期的な効果が期待できます。', '効果を予測する', 'formal', 'b2-unit-6'),
            _p('一方で、運用面の負担も増える可能性があります。', '懸念点を述べる', 'formal', 'b2-unit-5'),
            _p('関係者の合意を得てから進めます。', '進行条件を伝える', 'formal', 'b2-unit-1'),
            _p('代替案を三つ比較してみました。', '比較結果を導入する', 'formal', 'b2-unit-5'),
            _p('根拠となる資料を後ほど共有します。', '根拠資料の共有を伝える', 'formal', 'b2-unit-2'),
            _p('数字だけでなく利用者の声も重要です。', '定量と定性を対比する', 'neutral', 'b2-unit-2'),
            _p('この表現は少し強すぎるかもしれません。', '表現の強さを調整する', 'neutral', 'b2-unit-4'),
            _p('結論部分をもう少し明確にしましょう。', '文章改善を提案する', 'neutral', 'b2-unit-5'),
