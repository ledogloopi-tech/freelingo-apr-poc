...
B1_CATEGORIES: list[PhrasebookCategory] = [
    ...
    PhrasebookCategory(
        ...
        phrases=[
            ...
            _p('その点には賛成ですが、別の問題もあります。', '部分的に同意する', 'neutral', 'b1-unit-7'),
            ...
            _p('短期的には便利ですが、長期的には心配です。', '対比して評価する', 'neutral', 'b1-unit-7'),
            _p('この方法なら多くの人が参加できます。', '利点を説明する', 'neutral', 'b1-unit-7'),
            _p('結論を急がないほうがいいと思います。', '慎重な意見を述べる', 'neutral', 'b1-unit-7'),
        ],
    ),
    PhrasebookCategory(
        id='work_study_ja_b1',
    ...
    PhrasebookCategory(
        ...
        icon='🏙️',
        phrases=[
            _p('地域のイベントに参加してみたいです。', '地域活動への関心を示す', 'neutral', 'b1-unit-1'),
            ...
            _p('この問題について住民の意見を聞くべきです。', '地域課題への意見を述べる', 'neutral', 'b1-unit-7'),
    ...
    PhrasebookCategory(
        ...
        phrases=[
            ...
            _p('前職では資料作成を担当していました。', '過去の担当を説明する', 'formal', 'b1-unit-6'),
            _p('本日はお時間をいただきありがとうございます。', '面接で感謝する', 'formal', 'b1-unit-6'),
        ],
    ),
    PhrasebookCategory(
        ...
        phrases=[
            ...
            _p('その経験から多くのことを学びました。', '経験から得た学びを話す', 'neutral', 'b1-unit-2'),
            _p('以前より日本語で話す自信がつきました。', '成長を述べる', 'neutral', 'b1-unit-2'),
            _p('予定が合えば、ぜひ参加したいです。', '条件付きで参加を伝える', 'neutral', 'b1-unit-3'),
            _p('急な用事ができたので、少し遅れます。', '遅刻理由を説明する', 'neutral', 'b1-unit-3'),
            _p('その件について、後で相談してもいいですか。', '後で相談を依頼する', 'formal', 'b1-unit-4'),
            _p('相手の立場も考える必要があります。', '配慮を示す', 'neutral', 'b1-unit-4'),
            _p('環境のためにできることから始めたいです。', '環境への姿勢を述べる', 'neutral', 'b1-unit-5'),
            _p('このサービスは使いやすいと思います。', 'サービスを評価する', 'neutral', 'b1-unit-6'),
            ...
            _p('状況によって答えが変わると思います。', '条件による違いを述べる', 'neutral', 'b1-unit-7'),
