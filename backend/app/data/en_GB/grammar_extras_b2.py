...
B2_GRAMMAR_TOPICS: list[GrammarTopic] = [
    ...
    GrammarTopic(
        ...
        examples=[
            ...
            GrammarExample(
                text="He apologised for not calling sooner.",
    ...
    GrammarTopic(
        ...
        examples=[
            ...
            GrammarExample(
                text="It was because of the weather that we cancelled the trip.",
                note="it-cleft",
            ),
    ...
    GrammarTopic(
        ...
        examples=[
            ...
            GrammarExample(
                text="All staff are to complete the training by Friday.",
                note="instruction",
            ),
            GrammarExample(
