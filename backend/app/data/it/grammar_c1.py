...
C1_GRAMMAR_TOPICS: list[GrammarTopic] = [
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Benche fosse stanco, continuo a lavorare.", translation="Although he was tired, he kept working."),
            GrammarExample(text="Nonostante abbia studiato molto, non ha passato l esame.", translation="Despite having studied a lot, he didn't pass the exam."),
            GrammarExample(text="Sebbene sia tardi, resto ancora un po.", translation="Although it's late, I'll stay a little longer."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Benche era stanco, continuo.", correct="Benche fosse stanco, continuo.", note="Benche richiede sempre il congiuntivo."),
            GrammarMistake(wrong="Anche se fosse tardi... (non necessario)", correct="Anche se era tardi...", note="Anche se regge l'indicativo, non il congiuntivo."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Ti scrivo affinche tu sia informato.", translation="I'm writing so that you are informed."),
            GrammarExample(text="Parlo ad alta voce perche tutti sentano.", translation="I speak loudly so that everyone can hear."),
            GrammarExample(text="Studio ogni giorno per migliorare. (stesso soggetto)", translation="I study every day to improve."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Ti scrivo affinche sei informato.", correct="Ti scrivo affinche tu sia informato.", note="Affinche richiede il congiuntivo."),
            GrammarMistake(wrong="Studio per che imparo.", correct="Studio per imparare. (o: Studio affinche io impari.)", note="Stesso soggetto → per + infinito."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Cerco un libro che spieghi bene la grammatica. (non so se esiste)", translation="I'm looking for a book that explains grammar well.", note="ipotetico"),
            GrammarExample(text="E il film piu emozionante che io abbia mai visto.", translation="It's the most exciting film I've ever seen.", note="superlativo"),
            GrammarExample(text="Conosco un libro che spiega bene la grammatica.", translation="I know a book that explains grammar well.", note="certo → indicativo"),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Cerco una persona che parla inglese. (ma non so se esista)", correct="Cerco una persona che parli inglese.", note="Se la persona non e certa, si usa il congiuntivo."),
            GrammarMistake(wrong="E il piu bello che ho mai visto.", correct="E il piu bello che abbia mai visto.", note="Dopo superlativo relativo serve il congiuntivo."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="L'analisi dei dati ha richiesto tre mesi. (invece di: Abbiamo analizzato i dati per tre mesi.)", translation="The analysis of the data took three months."),
            GrammarExample(text="La costruzione del ponte fu completata nel 2010.", translation="The construction of the bridge was completed in 2010."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Eccesso di nominalizzazioni: 'L'effettuazione della verifica della documentazione...'", correct="Verificare la documentazione...", note="Troppe nominalizzazioni appesantiscono il testo."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Si ritiene che la situazione sia migliorata.", translation="It is believed that the situation has improved."),
            GrammarExample(text="E stato osservato un aumento dei prezzi.", translation="An increase in prices has been observed."),
            GrammarExample(text="Va notato che i risultati sono preliminari.", translation="It should be noted that the results are preliminary."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Io penso che... (in un testo accademico)", correct="Si ritiene che... / E opinione diffusa che...", note="In testi formali evitare la prima persona."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Nel campo semantico del cibo: pasta, pizza, risotto, insalata, formaggio, vino.", translation="In the semantic field of food: pasta, pizza, risotto, salad, cheese, wine."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Imparare liste di parole isolate.", correct="Imparare parole organizzate per campi semantici.", note="Il cervello memorizza meglio parole collegate tra loro."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Rileggere il testo aiuta a trovare errori.", translation="Rereading the text helps find errors.", note="ri- = di nuovo"),
            GrammarExample(text="La situazione e migliorabile.", translation="The situation can be improved.", note="-bile = che puo essere"),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Usare suffissi in modo arbitrario.", correct="Conoscere i suffissi produttivi per ogni categoria.", note="Non tutti i verbi formano nomi con -zione."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Il governo ha adottato misure per contrastare l'inflazione. (non: ha fatto cose)", translation="The government adopted measures to fight inflation."),
            GrammarExample(text="Il tramonto dipingeva il cielo di sfumature purpuree. (non: era bello)", translation="The sunset painted the sky with purple hues."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Ho fatto una bella esperienza.", correct="Ho vissuto un'esperienza entusiasmante/formativa/indimenticabile.", note="Bello e generico; scegliere aggettivo piu preciso."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Ma figurati, non vedevo l'ora di passare tre ore in coda alla posta!", translation="Oh sure, I couldn't wait to spend three hours in line at the post office!", note="ironia antifrastica"),
            GrammarExample(text="Ah, sei riuscito ad arrivare in orario! Miracolo!", translation="Oh, you managed to arrive on time! A miracle!", note="ironia bonaria"),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Prendere l'ironia alla lettera.", correct="Riconoscere l'ironia dal contesto e dal tono.", note="L'ironia italiana puo essere sottile e confondere."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Non capisco perche tutti dicano che gli italiani gesticolano... (mentre gesticola vistosamente)", translation="I don't understand why everyone says Italians gesture... (while gesturing emphatically)", note="autoironia"),
            GrammarExample(text="Il milanese e il napoletano si incontrano... (tipica barzelletta regionale)", translation="A Milanese and a Neapolitan meet... (typical regional joke)"),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Non capire l'umorismo regionale.", correct="Conoscere gli stereotipi regionali per capire le barzellette.", note="Molto umorismo italiano si basa su rivalita regionali."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Il riso abbonda sulla bocca degli sciocchi. (riso = ridere, ma anche cereale)", translation="Laughter/rice abounds in the mouths of fools.", note="doppio senso voluto"),
            GrammarExample(text="Ho lasciato la chiave sotto lo zerbino. (chiave fisica o soluzione?)", translation="I left the key under the doormat.", note="polisemia"),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Non cogliere il doppio senso in un titolo o barzelletta.", correct="Considerare tutti i significati possibili di una parola nel contesto.", note="I doppi sensi sono onnipresenti nella comunicazione italiana."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Ha un cuore d'oro.", translation="He has a heart of gold.", note="metafora"),
            GrammarExample(text="Non e affatto stupido. (litote per: e molto intelligente)", translation="He's not stupid at all.", note="litote"),
            GrammarExample(text="Ci vediamo tra due secondi! (iperbole)", translation="See you in two seconds!", note="iperbole"),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Confondere metonimia e metafora.", correct="Metafora = somiglianza; metonimia = contiguita.", note="Bere un bicchiere = metonimia (contenuto x contenitore)."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Avete mai pensato a cosa significhi per i nostri figli crescere in un mondo senza rispetto per l'ambiente?", translation="Have you ever thought about what it means for our children to grow up in a world without respect for the environment?", note="pathos + domanda retorica"),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Usare solo pathos senza dati.", correct="Bilanciare ethos, pathos e logos.", note="Un discorso persuasivo efficace combina tutte e tre le componenti."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Amici, romani, connazionali... prestatemi orecchio. (Shakespeare in italiano)", translation="Friends, Romans, countrymen... lend me your ears.", note="tricolon + invocazione"),
            GrammarExample(text="Una domanda semplice: siete soddisfatti di come vanno le cose? (pausa) Io no. E credo nemmeno voi.", translation="One simple question: are you satisfied with how things are going? (pause) I'm not. And I think you aren't either.", note="domanda retorica + pausa"),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Leggere un discorso senza pause ne enfasi.", correct="Provare il discorso ad alta voce, segnare le pause.", note="L'oratoria e performance, non solo testo."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="A Milano prendo un caffe, a Napoli prendo un caffe. (pronuncia e preparazione diversa)", translation="In Milan I have a coffee, in Naples I have a coffee.", note="differenza culturale + linguistica"),
            GrammarExample(text="Al Nord: 'Ho visto Marco ieri.' Al Sud: 'Vidi Marco ieri.'", translation="North: 'I saw Marco yesterday.' South: 'I saw Marco yesterday.'", note="passato prossimo vs remoto"),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Pensare che l'italiano sia uniforme in tutta Italia.", correct="Riconoscere e apprezzare le varieta regionali.", note="L'Italia ha una straordinaria diversita linguistica interna."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="In veneto: 'Come xeo che la va?' (Come va?)", translation="In Veneto: 'How's it going?'"),
            GrammarExample(text="A Napoli: 'Sto buono, guaglio!' (Stai bene, ragazzo!)", translation="In Naples: 'I'm good, boy!'"),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Confondere dialetto con italiano sgrammaticato.", correct="Il dialetto ha regole grammaticali proprie e una storia antica.", note="I dialetti italiani sono lingue romanze con pari dignita."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Standard: Ho telefonato loro. / Neostandard: Gli ho telefonato.", translation="Standard: I called them. / Neo-standard: I called them."),
            GrammarExample(text="Standard: Il libro che ho comprato. / Neostandard: Il libro che l'ho comprato.", translation="Standard: The book I bought. / Neo-standard: The book that I bought it."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Considerare sempre errore le forme neostandard.", correct="Distinguere tra registri: accettabile nel parlato, evitare nello scritto formale.", note="Il confine tra errore e innovazione linguistica e fluido."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Riassunto di 300 parole: il testo originale analizza le cause del declino economico italiano identificando tre fattori: demografia, produttivita e debito pubblico.", translation="300-word summary: the original text analyzes the causes of Italy's economic decline identifying three factors: demographics, productivity, and public debt."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Copiare frasi intere dall'originale.", correct="Riformulare con parole proprie, condensando.", note="La sintesi non e un collage di citazioni."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Il tuo lavoro e molto interessante. Forse si potrebbe approfondire la parte sui dati. Nel complesso, ottimo lavoro!", translation="Your work is very interesting. Perhaps the data section could be explored further. Overall, great job!", note="sandwich feedback"),
            GrammarExample(text="Hai considerato di strutturare diversamente questa sezione? Renderebbe il tutto piu chiaro.", translation="Have you considered structuring this section differently? It would make it clearer."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Questo lavoro e sbagliato. Devi rifarlo.", correct="Questo lavoro ha alcuni punti da rivedere. Vediamoli insieme per migliorarlo.", note="La critica costruttiva offre soluzioni, non solo giudizi."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Originale: La crisi economica ha colpito duramente le famiglie. Riformulato: I nuclei familiari hanno subito pesantemente gli effetti della recessione.", translation="Original: The economic crisis hit families hard. Reformulated: Households suffered heavily from the effects of the recession."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Cambiare il significato durante la riformulazione.", correct="Verificare che il messaggio originale sia preservato.", note="La riformulazione non deve alterare il contenuto."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="I dati sono stati raccolti mediante un questionario anonimo.", translation="Data were collected through an anonymous questionnaire.", note="passivo con essere"),
            GrammarExample(text="Si è osservato un aumento significativo dei casi.", translation="A significant increase in cases was observed.", note="si passivante"),
            GrammarExample(text="I risultati vanno interpretati alla luce del contesto storico.", translation="The results must be interpreted in light of the historical context.", note="andare + participio (obbligo)"),
            GrammarExample(text="È emerso che la maggioranza degli intervistati preferisce...", translation="It emerged that the majority of respondents prefer...", note="costruzione impersonale"),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Abbiamo scoperto che il fenomeno è frequente.", correct="È emerso che il fenomeno risulta frequente.", note="Evitare la prima persona nel registro accademico."),
            GrammarMistake(wrong="Si è analizzato i dati.", correct="Si sono analizzati i dati.", note="Il si passivante richiede accordo col soggetto."),
        ],
