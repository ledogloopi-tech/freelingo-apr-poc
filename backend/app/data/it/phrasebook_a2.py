...
A2_CATEGORIES: list[PhrasebookCategory] = [
    ...
    PhrasebookCategory(
        ...
        phrases=[
            ...
            PhrasebookEntry(
                text="Sono arrabbiato / arrabbiata.",
