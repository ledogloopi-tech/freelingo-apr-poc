...
C2_UNITS: list[CurriculumUnit] = [
    CurriculumUnit(
        ...
        vocabulary_set_ids=[
            "semantic_precision_c2",
            "advanced_particles_c2",
            "nuance_c2",
        ],
        lesson_types=[
            "grammar",
    ...
    CurriculumUnit(
        ...
        competency_checklist=[
            ...
            "번역 선택의 이유와 한계를 한국어로 설명하고 대안을 제시할 수 있다",
        ],
        default_weeks=2,
