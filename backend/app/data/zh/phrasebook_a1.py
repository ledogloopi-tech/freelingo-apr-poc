...
_SPECS = [
    (
        ...
        [
            ...
            ("很高兴认识你。", "初次见面时表达友好", "neutral", "a1-unit-2", "Hěn gāoxìng rènshi nǐ."),
    ...
    (
        ...
        [
            ...
            ("这个中文怎么说？", "询问如何用中文表达", "neutral", "a1-unit-1", "Zhège zhōngwén zěnme shuō?"),
    ...
    (
        ...
        [
            ...
            ("请给我看看别的。", "想看其他商品时", "neutral", "a1-unit-7", "Qǐng gěi wǒ kànkan bié de."),
        ],
    ),
    (
        "restaurant_a1",
    ...
    (
        ...
        [
            ...
            ("这辆车去市中心吗？", "确认公交路线时", "neutral", "a1-unit-6", "Zhè liàng chē qù shìzhōngxīn ma?"),
            ("请给我一张票。", "买车票时", "neutral", "a1-unit-6", "Qǐng gěi wǒ yì zhāng piào."),
            ("我在这里下车吗？", "确认下车地点时", "neutral", "a1-unit-6", "Wǒ zài zhèlǐ xiàchē ma?"),
    ...
    (
        ...
        [
            ...
            ("请告诉我电话号码。", "询问电话号码时", "neutral", "a1-unit-8", "Qǐng gàosu wǒ diànhuà hàomǎ."),
        ],
    ),
]
