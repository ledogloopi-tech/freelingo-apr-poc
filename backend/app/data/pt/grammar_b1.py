...
B1_GRAMMAR_TOPICS: list[GrammarTopic] = [
    GrammarTopic(
        ...
        examples=[
            ...
            GrammarExample(text="Duvido que ele venha.", translation="I doubt he will come.", note="vir, irregular"),
            GrammarExample(text="É importante que tu estudes.", translation="It is important that you study."),
            GrammarExample(text="Queres que eu vá contigo?", translation="Do you want me to go with you?"),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Espero que tu falas com ela.", correct="Espero que tu fales com ela.", note="Depois de que, usa-se conjuntivo."),
            GrammarMistake(wrong="É preciso que ele vai.", correct="É preciso que ele vá.", note="Ir no conjuntivo: vá."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Espero que tenhas uma boa viagem.", translation="I hope you have a good trip."),
            GrammarExample(text="Quero que vocês sejam felizes.", translation="I want you to be happy."),
            GrammarExample(text="Oxalá não chova amanhã.", translation="Let's hope it doesn't rain tomorrow."),
            GrammarExample(text="Tomara que ela consiga o emprego.", translation="I hope she gets the job."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Espero que tens sucesso.", correct="Espero que tenhas sucesso.", note="Conjuntivo após espero que."),
            GrammarMistake(wrong="Quero que ele é pontual.", correct="Quero que ele seja pontual.", note="Ser no conjuntivo: seja."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            ...
            GrammarExample(text="Talvez ela saiba a resposta.", translation="Maybe she knows the answer."),
            GrammarExample(text="Vamos talvez ao cinema.", translation="Maybe we'll go to the cinema."),
            GrammarExample(text="Talvez seja melhor esperar.", translation="Maybe it's better to wait."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Talvez ele vai.", correct="Talvez ele vá.", note="O padrão com talvez é o conjuntivo."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="É preciso que acabes o trabalho.", translation="You need to finish the work."),
            GrammarExample(text="É importante que todos participem.", translation="It's important that everyone participates."),
            GrammarExample(text="Convém que tragas o passaporte.", translation="You should bring your passport."),
            GrammarExample(text="É melhor que vás ao médico.", translation="You'd better go to the doctor."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="É preciso que tu acabas.", correct="É preciso que tu acabes.", note="É preciso que exige conjuntivo."),
            GrammarMistake(wrong="É importante ele vai.", correct="É importante que ele vá.", note="Ir no conjuntivo: vá."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Duvido que ela saiba a resposta.", translation="I doubt she knows the answer."),
            GrammarExample(text="Não acho que seja uma boa ideia.", translation="I don't think it's a good idea."),
            GrammarExample(text="É possível que cheguemos atrasados.", translation="It's possible we'll arrive late."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Não acho que ele tem razão.", correct="Não acho que ele tenha razão.", note="Negação + que → conjuntivo."),
            GrammarMistake(wrong="É possível que ela sabe.", correct="É possível que ela saiba.", note="É possível que exige conjuntivo."),
        ],
        related=["presente-conjuntivo", "talvez", "subjuntivo-recomendacao"],
    ),
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="É bom que estejas aqui.", translation="It's good that you're here."),
            GrammarExample(text="É uma pena que não possas vir.", translation="It's a shame you can't come."),
            GrammarExample(text="Que bom que tenhas gostado!", translation="I'm so glad you liked it!"),
        ],
        common_mistakes=[
            GrammarMistake(wrong="É bom que estás aqui.", correct="É bom que estejas aqui.", note="É bom que exige conjuntivo."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Tenho ido ao ginásio todas as semanas.", translation="I have been going to the gym every week.", note="repetida"),
            GrammarExample(text="Ela tem andado muito cansada.", translation="She has been very tired lately."),
            GrammarExample(text="Ultimamente tenho pensado em ti.", translation="Lately I've been thinking about you."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Tenho comido bacalhau ontem.", correct="Comi bacalhau ontem.", note="Ação única passada: pretérito simples, não composto."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Quando cheguei, ela já saíra.", translation="When I arrived, she had already left.", note="literário"),
            GrammarExample(text="Quando cheguei, ela já tinha saído.", translation="When I arrived, she had already left.", note="composto, comum"),
        ],
        common_mistakes=[
            GrammarMistake(wrong="A", correct="m", note="b"),
        ],
        related=["preterito-perfeito-composto", "marcadores-composto", "preterito-mais-que-perfeito"],
    ),
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Ultimamente tenho pensado muito nisso.", translation="Lately I've been thinking a lot about that."),
            GrammarExample(text="Nos últimos meses tenho trabalhado muito.", translation="In recent months I've been working a lot."),
            GrammarExample(text="Até agora tudo tem corrido bem.", translation="So far everything has been going well."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Ultimamente estudei muito.", correct="Ultimamente tenho estudado muito.", note="Ultimamente pede composto."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="O bolo foi feito pela minha avó.", translation="The cake was made by my grandmother."),
            GrammarExample(text="As cartas são entregues de manhã.", translation="The letters are delivered in the morning."),
            GrammarExample(text="A ponte foi construída em 1900.", translation="The bridge was built in 1900."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="O bolo foi feito por minha avó.", correct="O bolo foi feito pela minha avó.", note="Pela = por+a, contração obrigatória."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Vive-se bem nesta cidade.", translation="One lives well in this city."),
            GrammarExample(text="Precisa-se de voluntários.", translation="Volunteers are needed.", note="singular"),
            GrammarExample(text="Aqui come-se bem.", translation="One eats well here."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Precisam-se de voluntários.", correct="Precisa-se de voluntários.", note="Se impessoal: verbo fica no singular."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Vende-se este apartamento.", translation="This apartment is for sale."),
        ...
        common_mistakes=[
            GrammarMistake(wrong="Vende-se carros.", correct="Vendem-se carros.", note="Se passivo: verbo concorda com carros (plural)."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="O livro que estou a ler é fascinante.", translation="The book I'm reading is fascinating."),
            GrammarExample(text="A pessoa que telefonou não deixou nome.", translation="The person who called didn't leave a name."),
            GrammarExample(text="O filme de que te falei ganhou um prémio.", translation="The film I told you about won a prize.", note="formal"),
        ],
        common_mistakes=[
            GrammarMistake(wrong="O livro que eu gosto.", correct="O livro de que eu gosto.", note="Gostar exige de: de que."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="A casa onde cresci era no campo.", translation="The house where I grew up was in the countryside."),
            GrammarExample(text="O país de onde venho é frio.", translation="The country I come from is cold."),
            GrammarExample(text="Lembro-me do dia quando nos conhecemos.", translation="I remember the day when we met."),
            GrammarExample(text="Esta é a razão pela qual não fui.", translation="This is the reason why I didn't go.", note="razão → pela qual"),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Uma situação onde todos ganham.", correct="Uma situação em que todos ganham.", note="Onde é só para lugar físico."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="O escritor cujo livro ganhou o prémio.", translation="The writer whose book won the prize."),
            GrammarExample(text="A rapariga cuja mãe conheces.", translation="The girl whose mother you know."),
            GrammarExample(text="As empresas cujos funcionários estão em greve.", translation="The companies whose employees are on strike."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="O homem cujo o filho é médico.", correct="O homem cujo filho é médico.", note="Cujo nunca leva artigo."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Se tivesse estudado, teria passado no exame.", translation="If I had studied, I would have passed the exam."),
            GrammarExample(text="Ela teria vindo se soubesse.", translation="She would have come if she had known."),
            GrammarExample(text="Sem a tua ajuda, não teríamos conseguido.", translation="Without your help, we wouldn't have managed."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Se tinha estudado, teria passado.", correct="Se tivesse estudado, teria passado.", note="Se + condição passada: MQP conjuntivo."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Se eu tivesse tempo, ia contigo.", translation="If I had time, I'd go with you.", note="coloquial"),
            GrammarExample(text="Se ela estudasse mais, passaria.", translation="If she studied more, she would pass."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Se eu tinha dinheiro, viajava.", correct="Se eu tivesse dinheiro, viajava.", note="Condição hipotética: se + conjuntivo."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Quando chegares, avisa-me.", translation="When you arrive, let me know."),
            GrammarExample(text="Se puderem, venham cedo.", translation="If you can, come early."),
            GrammarExample(text="Assim que souber, digo-te.", translation="As soon as I know, I'll tell you."),
            GrammarExample(text="Enquanto houver esperança, continuaremos.", translation="As long as there is hope, we'll continue."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Quando chegas, avisa-me.", correct="Quando chegares, avisa-me.", note="Ação futura: quando + futuro conjuntivo."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Ela disse: Estou cansada. → Ela disse que estava cansada.", translation="She said she was tired."),
            GrammarExample(text="Ele perguntou: Já comeste? → Ele perguntou se eu já tinha comido.", translation="He asked if I had already eaten."),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Ela disse que está cansada. (com disse)", correct="Ela disse que estava cansada.", note="Disse está no passado → tempo recua."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Fiquei em casa porque estava a chover.", translation="I stayed home because it was raining.", note="causa"),
            GrammarExample(text="Estava a chover, por isso fiquei em casa.", translation="It was raining, so I stayed home.", note="consequência"),
            GrammarExample(text="Embora estivesse a chover, fui passear.", translation="Although it was raining, I went for a walk.", note="concessão + conjuntivo"),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Embora está a chover, vou sair.", correct="Embora esteja a chover, vou sair.", note="Embora exige conjuntivo."),
        ],
    ...
    GrammarTopic(
        ...
        examples=[
            GrammarExample(text="Estudo português para viajar por Portugal.", translation="I study Portuguese (in order) to travel around Portugal.", note="para = finalidade; por = lugar aproximado"),
            GrammarExample(text="Obrigado por tudo. O presente é para ti.", translation="Thanks for everything. The gift is for you.", note="por = causa do agradecimento; para = destinatário"),
            GrammarExample(text="Passei por tua casa mas não estavas.", translation="I passed by your house but you weren't there.", note="lugar"),
            GrammarExample(text="Este relatório é para sexta-feira.", translation="This report is for Friday.", note="prazo"),
        ],
        common_mistakes=[
            GrammarMistake(wrong="Obrigado para a ajuda.", correct="Obrigado pela ajuda.", note="Com \"obrigado\" usa-se \"por\"."),
            GrammarMistake(wrong="Estudo por ser médico.", correct="Estudo para ser médico.", note="\"Para\" + infinitivo indica o propósito."),
            GrammarMistake(wrong="A ponte foi construída para os romanos.", correct="A ponte foi construída pelos romanos.", note="O agente da passiva introduz-se com \"por\"."),
        ],
